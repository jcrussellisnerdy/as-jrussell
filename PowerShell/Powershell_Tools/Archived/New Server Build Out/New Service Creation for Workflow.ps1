...
New-Service -Name "$Service" -BinaryPathName """E:\Services\$Service\OspreyWorkflowService.exe"" -SVCNAME:$Service" -DisplayName "$Service" -StartupType Automatic -Description "$Service"}

$UserName = "WFLService@as.local" 
$Password = "dF7zFIn8Y5HAOMVNhzuP"
