...
Foreach ($service in $service_names){
   ...
   Move-Item -Path "\\as.local\shared\InfoTech\Application Administrators\Unitrac\Unitrac_Misc\LDHONEMAIN" "\\MSP-DFS-01\InformationTechnology\UniTrac_Master_Configs\Test\STAGE" -Force
