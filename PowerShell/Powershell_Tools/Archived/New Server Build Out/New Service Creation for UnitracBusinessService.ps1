...
New-Service -Name "$Service" -BinaryPathName """E:\Services\$Service\UnitracBusinessService.exe"" -SVCNAME:$Service" -DisplayName "$Service" -StartupType Automatic -Description "$Service"}
