...
Get-Service	 -ComputerName	Unitrac-APP02	 -Name	UniTracBusinessServiceMatchIn7 |Stop-Service -Force -NoWait
Get-Service	 -ComputerName	Unitrac-WH01	 -Name	LDHServicePRCPA |Stop-Service -Force -NoWait
Get-Service	 -ComputerName	Unitrac-WH02	 -Name	UniTracBusinessServiceMatchInN  |Stop-Service -Force -NoWait
Get-Service	 -ComputerName	Unitrac-WH02	 -Name	UniTracBusinessServiceMatchIn9 |Stop-Service -Force -NoWait
Get-Service	 -ComputerName	Unitrac-WH03	 -Name	UniTracBusinessServiceMatchIn10 |Stop-Service -Force -NoWait
Get-Service	 -ComputerName	Unitrac-WH03	 -Name	ListenService |Stop-Service -Force -NoWait
...
Get-Service	 -ComputerName	Unitrac-WH04	 -Name	UnitracBusinessServiceMatchInL |Stop-Service -Force -NoWait
...
Get-Service	 -ComputerName	Unitrac-WH07	 -Name	UnitracBusinessServiceMatchIn1 |Stop-Service -Force -NoWait
...
Get-Service	 -ComputerName	Unitrac-WH07	 -Name	UnitracBusinessServiceMatchIn17 |Stop-Service -Force -NoWait
...
Get-Service	 -ComputerName	 Unitrac-WH08	 -Name	UniTracBusinessServiceMatchIn8 |Stop-Service -Force -NoWait
Get-Service	 -ComputerName	 Unitrac-WH09	 -Name	UniTracBusinessServiceMatchIn5 |Stop-Service -Force -NoWait
Get-Service	 -ComputerName	 Unitrac-WH09	 -Name	UniTracBusinessServiceMatchIn4 |Stop-Service -Force -NoWait
...
Get-Service	 -ComputerName	 Unitrac-WH10	 -Name	UniTracBusinessServiceMatchIn6  |Stop-Service -Force -NoWait
Get-Service	 -ComputerName	 Unitrac-WH10	 -Name	WorkflowService2  |Stop-Service -Force -NoWait
Get-Service	 -ComputerName	 Unitrac-WH11	 -Name	UniTracBusinessServiceMatchIn12  |Stop-Service -Force -NoWait
Get-Service	 -ComputerName	 Unitrac-WH11	 -Name	WorkflowService3 |Stop-Service -Force -NoWait
Get-Service	 -ComputerName	 Unitrac-WH12	 -Name	UniTracBusinessServiceMatchIn13 |Stop-Service -Force -NoWait
Get-Service	 -ComputerName	 Unitrac-WH12	 -Name	UniTracBusinessServiceMatchIn18 |Stop-Service -Force -NoWait
...
Get-Service	 -ComputerName	 Unitrac-WH14	 -Name	UnitracBusinessServiceMatchIn16 |Stop-Service -Force -NoWait
Get-Service	 -ComputerName	 Unitrac-WH15	 -Name	UnitracBusinessServiceMatchIn15 |Stop-Service -Force -NoWait
Get-Service	 -ComputerName	 Unitrac-WH16	 -Name	UnitracBusinessServiceCycle3 |Stop-Service -Force -NoWait
Get-Service	 -ComputerName	 Unitrac-WH16	 -Name	UnitracBusinessServiceMatchInF |Stop-Service -Force -NoWait
...
Get-Service	 -ComputerName	 Unitrac-WH17	 -Name	UnitracBusinessServiceMatchInJ |Stop-Service -Force -NoWait
Get-Service	 -ComputerName	 Unitrac-WH18	 -Name	UnitracBusinessServiceMatchIn14 |Stop-Service -Force -NoWait
...
Get-Service	 -ComputerName	 Unitrac-WH20	 -Name	UnitracBusinessServiceMatchInK |Stop-Service -Force -NoWait
