Start-Transcript -Path "\\usd-rd02\c$\logs\PowerShell Logs\PreProd.txt"
...
$sourcePath = "\\tfs-build-06\E$\UniTrac\Setups\Version Hotfix\LDH\UnitracSSO"
...
$sourcePath = "\\tfs-build-06\E$\UniTrac\Setups\Version Hotfix\LDH\VehicleLookupService"
...
Get-ChildItem -Path "\\UTPreProd-APP01\C$\Program Files (x86)\AlliedSolutions\LDHServices\LDHServiceVUT" -Recurse -ErrorAction SilentlyContinue | 
Remove-Item -Force -Recurse -ErrorAction SilentlyContinue
...
Remove-Item -Force -Recurse -ErrorAction SilentlyContinue
 ...
 Get-ChildItem -Path "\\UTPreProd-APP01\C$\Program Files (x86)\AlliedSolutions\LDHServices\MSGSRVREXTVUT" -Recurse -ErrorAction SilentlyContinue | 
Remove-Item -Force -Recurse -ErrorAction SilentlyContinue
...
$sourcePath = "\\tfs-build-06\E$\UniTrac\Setups\Version Hotfix\LDH\LDHService"
...
$sourcePath = "\\tfs-build-06\E$\UniTrac\Setups\Version Hotfix\LDH\LDHService"
$destPath =  "\\UTPreProd-APP01\C$\Program Files (x86)\AlliedSolutions\LDHServices\LDHServiceVUT"
...
$sourcePath = "\\tfs-build-06\E`$\UniTrac\Setups\Version Hotfix\LDH\UnitracBusinessService"
...
$sourcePath = "\\tfs-build-06\E`$\UniTrac\Setups\Version Hotfix\LDH\DirectoryWatcherServer"
...
$sourcePath = "\\tfs-build-06\E`$\UniTrac\Setups\Version Hotfix\LDH\MessageServer"
...
$sourcePath = "\\tfs-build-06\E`$\UniTrac\Setups\Version Hotfix\LDH\MessageServer"
$destPath =  "\\UTPreProd-APP01\C$\Program Files (x86)\AlliedSolutions\LDHServices\MSGSRVREXTVUT"
...
$sourcePath = "\\tfs-build-06\E`$\UniTrac\Setups\Version Hotfix\LDH\OspreyWorkflowService"
...
Get-ChildItem   "\\as.local\shared\InfoTech\UniTrac_Master_Configs\Test\PreProd\LDHServiceVUT\Osprey.LDHService.exe.config" |Copy-Item -Destination  "\\UTPreProd-APP01\C$\Program Files (x86)\AlliedSolutions\LDHServices\LDHServiceVUT" -Force
...
Get-ChildItem   "\\as.local\shared\InfoTech\UniTrac_Master_Configs\Test\PreProd\MSGSRVREXTVUT\Osprey.MessageServer.exe.config" |Copy-Item -Destination  "\\UTPreProd-APP01\C$\Program Files (x86)\AlliedSolutions\LDHServices\MSGSRVREXTVUT" -Force
...
if(Test-Path "\\usd-rd02\c$\logs\PowerShell Logs\PreProd.txt"){
$destination = "\\usd-rd02\c$\logs\PowerShell Logs\PreProd"+[DateTime]::Now.ToString("yyyyMMdd-HHmmss")+".txt"
Copy-Item -Path "\\usd-rd02\c$\logs\PowerShell Logs\PreProd.txt" -Destination $destination
}


Remove-Item -Path "\\usd-rd02\c$\logs\PowerShell Logs\PreProd.txt"