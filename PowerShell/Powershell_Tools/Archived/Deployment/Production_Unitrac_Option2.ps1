...
Write-Output "Updating UnitracBusinessService code"
...
Write-Output "Updating LDHServices code"
...
Write-Output "Updating WorkflowService code"
...
Write-Output "Updating DirectoryWatchers code"
...
Write-Output "Updating Message Services code"
