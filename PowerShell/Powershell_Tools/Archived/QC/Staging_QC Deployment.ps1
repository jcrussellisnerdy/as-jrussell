...
Get-ChildItem   "\\as.local\shared\InfoTech\UniTrac_Master_Configs\Test\Stage\QCImportProcess\QCModuleBusinessService.exe.config" |Copy-Item -Destination  "\\utstage-app4\D$\Services\QCImportProcess"  -Force
    
Get-ChildItem   "\\as.local\shared\InfoTech\UniTrac_Master_Configs\Test\Stage\QCCleanupProcess\QCModuleBusinessService.exe.config" |Copy-Item -Destination   "\\utstage-app4\D$\Services\QCCleanupProcess" -Force
 
Get-ChildItem   "\\as.local\shared\InfoTech\UniTrac_Master_Configs\Test\Stage\QCBatchSendProcess\QCModuleBusinessService.exe.config" |Copy-Item -Destination  "\\utstage-app4\D$\Services\QCBatchSendProcess" -Force
    
Get-ChildItem   "\\as.local\shared\InfoTech\UniTrac_Master_Configs\Test\Stage\QCBatchEvaluationProcess\QCModuleBusinessService.exe.config" |Copy-Item -Destination  "\\utstage-app4\D$\Services\QCBatchEvaluationProcess" -Force
