...
rem \\unitrac-wh07.colo.as.local %1 ldhserviceHUNT
rem -------------------------------------------------------
...
rem \\unitrac-wh19.colo.as.local %1 ldhserviceSANT
rem -------------------------------------------------------
...
rem \\unitrac-wh04.colo.as.local %1 ldhserviceADHOC
rem -------------------------------------------------------
...
rem \\unitrac-wh20.colo.as.local %1 ldhserviceusdSANT
rem -------------------------------------------------------
