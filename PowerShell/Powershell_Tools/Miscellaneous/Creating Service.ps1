...
#For one service
New-Service -Name "$Service" -BinaryPathName """C:\Services\$Service\UnitracBusinessService.exe"" -SVCNAME:$Service" -DisplayName "$Service" -StartupType Automatic -Description "$Service"