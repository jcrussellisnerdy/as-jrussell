...
#find matchString in the files from a specified filePath. optionally, if it exists, replace it with the newString value.
  ...
  $filePath = "\\as.local\shared\InfoTech\UniTrac_Master_Configs\Test\STAGE\"
  ...
  $matchString = '    <add key="UserId" value="ykGX/FdKYchEg5OZ0B7PIA==" />'

 

   # only used if doReplace is set to yes
  $newString =   '<!--FileC related settings START-->'
