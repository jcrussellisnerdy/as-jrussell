...
#find matchString in the files from a specified filePath. optionally, if it exists, replace it with the newString value.
  ...
  $filePath = "\\as.local\shared\InfoTech\UniTrac_Master_Configs\ArchivedConfigs\Test\STAGE - 2018-10-03\"
  ...
  $matchString = 'http://test.solutionsbytext.com'
 


   # only used if doReplace is set to yes
  $newString =   'http://ui.solutionsbytext.com' 
