...
#find matchString in the files from a specified filePath. optionally, if it exists, replace it with the newString value.
  ...
  $filePath = "\\MSP-DFS-01\InformationTechnology\UniTrac_Master_Configs\Prod\*.config"
  ...
  $matchString = '<add key = "RPAService.Vehicle" value = "http://rpaservices.alliedsolutions.net/RPAInbound/RPAInbound.svc/VehicleVOW" />
<add key = "RPAService.Mortgage" value = "http://rpaservices.alliedsolutions.net/RPAInbound/RPAInbound.svc/MortgageVOW" />'


   # only used if doReplace is set to yes
  $newString =  
'<add key = "RPAService.Vehicle" value = "http://rpaservices.alliedsolutions.net/RPAInbound/RPAInbound.svc/VehicleVOW" />
<add key = "RPAService.Mortgage" value = "http://rpaservices.alliedsolutions.net/RPAInbound/RPAInbound.svc/MortgageVOW" />'
