...
,WF_DESC_WORK_ITEM_TYPE                                       TEXT(80)             
...
,BILLINGGROUP_DESCRIPTION                                     TEXT(100)            
...
,BILLINGGROUP_PDESCRPTION                                     TEXT(100)            
...
,WF_DESC_PURGE_DT                                             DATETIME             
,BG_ID                                                        NUMBER(38,0)         
,WQ_ID                                                        NUMBER(38,0)         
,WF_DESC_ID                                                   NUMBER(38,0)         
...
DESC EDW_TEST.CDW.D_UT_RELATED_DATA_TEMP;

create or replace TABLE EDW_PROD.STG.D_UT_RELATED_DATA_TEMP (
	D_UT_RELATED_DATA_ID NUMBER(38,0) NOT NULL,
	RELATED_DATA_ID NUMBER(38,0) NOT NULL,
	RELATE_ID NUMBER(38,0) NOT NULL,
	DEF_ID NUMBER(38,0) NOT NULL,
	VALUE_TX VARCHAR(100) NOT NULL,
	...
	LOCK_ID NUMBER(4,0) NOT NULL,
	SRC_UPDATE_USER_TX VARCHAR(15),
	BATCH_ID NUMBER(38,0) NOT NULL,
	HASH_ID VARCHAR(32) NOT NULL,
	CREATE_DT TIMESTAMP_NTZ(9) NOT NULL,
	UPDATE_USER_TX VARCHAR(50) NOT NULL,
	CURRENT_FLG VARCHAR(1) NOT NULL,
	EFFECTIVE_FROM_DT TIMESTAMP_NTZ(9) NOT NULL,
	EFFECTIVE_TO_DT TIMESTAMP_NTZ(9) NOT NULL,
	primary key (D_UT_RELATED_DATA_ID)
);
...
DESC EDW_TEXT.STG.STG_UT_FINANCIAL_TXN_H

ALTER TABLE EDW_PROD.STG.STG_UT_FINANCIAL_TXN_H ADD COLUMN DETAIL_PURGE_DT DATETIME;
ALTER TABLE EDW_PROD.STG.STG_UT_FINANCIAL_TXN_H ADD COLUMN DETAIL_TXN_TYPE_CD TEXT(10);
ALTER TABLE EDW_PROD.STG.STG_UT_FINANCIAL_TXN_H ADD COLUMN DETAIL_UPDATE_DT DATETIME;
ALTER TABLE EDW_PROD.STG.STG_UT_FINANCIAL_TXN_H ADD COLUMN DETAIL_UPDATE_USER_TX TEXT(15);
ALTER TABLE EDW_PROD.STG.STG_UT_FINANCIAL_TXN_H ADD COLUMN FINANCIAL_TXN_ID NUMBER(38,0);
ALTER TABLE EDW_PROD.STG.STG_UT_FINANCIAL_TXN_H ADD COLUMN SRC_UPDATE_USER_TX TEXT(15);
