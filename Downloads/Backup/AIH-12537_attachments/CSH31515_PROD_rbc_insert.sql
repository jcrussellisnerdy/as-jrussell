...
-- DO NOT MODIFY IF ON PRODUCTION SERVER -- FOR DEVELOPMENT TESTING ONLY
	...
	@IF_VERBOSE				varchar(10) = 'TRUE'	-- defaulte = TRUE
...
BULK INSERT #tmpRBC 
--FROM '\\UT-SQLSTG-01\e$\BulkInserts\CSH31515\CSH31515_RBC.txt'
FROM '\\ON-SQLCLSTPRD-1\BulkInserts$\CSH31515\CSH31515_RBC.txt'
--FROM '\\UTQA-SQL-14\e$\BulkInserts\INC0506135\rbc_data.txt'
WITH
(
	FIRSTROW			= 1,
	FIELDTERMINATOR		= '\t',
