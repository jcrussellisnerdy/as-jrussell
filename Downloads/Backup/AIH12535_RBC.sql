...
declare 
	@update_user_tx		varchar(15)		= 'CSH32686RBC_1',

-- Used to create RATE_GROUP_ID entry
	@carrier			varchar(50)		= 'Lloyds.Haz', --CARRIER Code_TX
	@rate_group_code_tx varchar(50)		= 'Lloyds_CovantageWind_BW'
...
--	Flags
declare
	@IF_CREATE_RATE_GROUP		varchar(10)	= 'TRUE',	-- default = TRUE : Will create a Rate Group Id, 
...
-- DO NOT MODIFY IF ON PRODUCTION SERVER -- FOR DEVELOPMENT TESTING ONLY
	...
	@IF_VERBOSE				varchar(10) = 'FALSE'	-- default = TRUE
...
BULK INSERT #tmpRBC 
--FROM '\\ON-SQLCLSTPRD-1\BulkInserts$\CSH30463_1\rbc_data.txt'
FROM '\\ON-SQLCLSTPRD-1\BulkInserts$\CSH32686\CSH32686_rbc_data.txt'
--FROM '\\UTSTAGE-SQL-01\e$\BulkInserts\CSH30463_1\rbc_data.txt'
WITH
(
	FIRSTROW			= 1,
	FIELDTERMINATOR		= '\t',
