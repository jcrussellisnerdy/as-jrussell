USE [DBA]
GO
/****** Object:  StoredProcedure [alert].[Send]    Script Date: 9/13/2019 12:23:28 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO

IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[alert].[Send]') AND type in (N'P', N'PC'))
BEGIN
	EXEC dbo.sp_executesql @statement = N'CREATE PROCEDURE [alert].[Send] AS RETURN 0;' 
END
GO

ALTER PROCEDURE [alert].[Send] 
