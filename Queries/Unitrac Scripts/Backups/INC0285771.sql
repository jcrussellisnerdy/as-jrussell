...
WHERE   WI.ID IN ( 35923007, 36315998, 36316099 , 37265115  )
...
SELECT * INTO UniTracHDStorage..LOAN_INC0285771
FROM dbo.LOAN WHERE ID IN (SELECT LOAN_ID FROM #TMPWI)

SELECT * INTO UniTracHDStorage..WI_INC0285771
