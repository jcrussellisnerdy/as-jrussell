/****** Object:  StoredProcedure [dbo].[Report_ExtractReports]     ******/
...
/****** Object:  StoredProcedure [dbo].[Report_ExtractReports]    Script Date: 2/21/2013 15:04:42 ******/
SET ANSI_NULLS ON
GO
...
UPDATE T
SET PROPERTY_DESCRIPTION = dbo.fn_GetPropertyDescriptionForReports(T.COLLATERAL_ID)
FROM #T2 T
...
ALTER TABLE #T2 DROP COLUMN CPI_QUOTE_ID
