...
----REPLACE INC0252822 WITH TICKET NUMBER
SELECT * 
--INTO UniTracHDStorage..INC0252822
FROM UniTrac..WORK_ITEM
WHERE ID IN (34574616 , 34620150)
...
VALUES  ( 34574616  , -- WORK_ITEM_ID - bigint
          ...
          N'INC0252822' , -- UPDATE_USER_TX - nvarchar(15)
          1 , -- LOCK_ID - tinyint
...
LAST_WORK_ITEM_ACTION_ID = (SELECT MAX(ID) FROM dbo.WORK_ITEM_ACTION WHERE   WORK_ITEM_ID IN ( 34574616  )),
UPDATE_DT = GETDATE(),LOCK_ID = LOCK_ID+1, UPDATE_USER_TX = 'INC0252822'
WHERE   ID IN ( 34574616  )
...
VALUES  ( 34620150  , -- WORK_ITEM_ID - bigint
          N'Complete' , -- ACTION_CD - nvarchar(30)
          N'Initial' , -- FROM_STATUS_CD - nvarchar(20)
          N'Complete' , -- TO_STATUS_CD - nvarchar(20)
          5 , -- CURRENT_QUEUE_ID - bigint
...
UPDATE  UniTrac..WORK_ITEM
SET     STATUS_CD = 'Complete', 
LAST_WORK_ITEM_ACTION_ID = (SELECT MAX(ID) FROM dbo.WORK_ITEM_ACTION WHERE   WORK_ITEM_ID IN ( 34620150  )),
UPDATE_DT = GETDATE(),LOCK_ID = LOCK_ID+1, UPDATE_USER_TX = 'INC0252822'
WHERE   ID IN ( 34620150  )
        AND WORKFLOW_DEFINITION_ID = 7
        AND ACTIVE_IN = 'Y'
