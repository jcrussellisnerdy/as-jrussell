...
/****** Object:  StoredProcedure [dbo].[GetBillingFileDetails]    Script Date: 1/6/2017 11:31:02 AM ******/
SET ANSI_NULLS ON
GO
...
BEGIN
   ...
   select   @useMonthlyBreakouts = CASE WHEN RD.VALUE_TX = 'true' THEN 1 ELSE 0 END
   from     RELATED_DATA RD 
            LEFT JOIN RELATED_DATA_DEF RDD ON RD.DEF_ID = RDD.ID
   where    RD.RELATE_ID = 
            (
               select   top 1 L.LENDER_ID
               from     #t1 t
            ...
            and RDD.NAME_TX = 'UsesCustomMonthlyBillingProration'
