...
SELECT CONTENT_XML.value('(/Content/Lender/Code)[1]', 'varchar (50)') Lender, * INTO UniTracHDStorage..WI_INC0233778
...
WHERE   LENDER.CODE_TX = '3387'
		...
		AND WI.ID IN (SELECT ID FROM UniTracHDStorage..WI_INC0233778 )
		
SELECT * FROM #TMPWI

SELECT * INTO UniTracHDStorage..LOAN_INC0233778
