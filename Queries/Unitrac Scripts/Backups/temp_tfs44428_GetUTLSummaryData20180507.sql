if not exists (select 1 from sys.procedures where name = 'Temp_TFS44428_GetUTLSummaryData')
	exec ('create proc Temp_TFS44428_GetUTLSummaryData as return')
GO

ALTER PROCEDURE Temp_TFS44428_GetUTLSummaryData
...
SELECT 
	...
	,CONVERT(CHAR(10), rd.create_dt,101) UTL20LiveDate
	,u2.UTL20Matches
	,CAST(u2.UTL20AvgDaileyMatches AS NUMERIC(18,1)) UTL20AvgDaileyMatches
	,CAST(u1.UTL10AvgDaileyMatches/u2.UTL20AvgDaileyMatches AS NUMERIC(18,1))
	,CAST(u2.UTL20AvgDaileyMatches/u1.UTL10AvgDaileyMatches AS NUMERIC(18,1))
...
AND rdd.NAME_TX = 'UTL2.0' 
AND rd.VALUE_TX = 'true'
INNER JOIN lender l ON u1.LENDER_ID = l.id AND l.PURGE_DT IS null
ORDER BY l.NAME_TX, u1.MATCH_RESULT_CODE
