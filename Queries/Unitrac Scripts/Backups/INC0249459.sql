...
SELECT * 
INTO UniTracHDStorage..INC0249459
FROM UniTrac..WORK_ITEM
WHERE ID IN (33694415 )
...
VALUES  ( 33694415  , -- WORK_ITEM_ID - bigint
          ...
          N'INC0249459' , -- UPDATE_USER_TX - nvarchar(15)
          1 , -- LOCK_ID - tinyint
...
LAST_WORK_ITEM_ACTION_ID = (SELECT MAX(ID) FROM dbo.WORK_ITEM_ACTION WHERE   WORK_ITEM_ID IN ( 33694415  )),
UPDATE_DT = GETDATE(),LOCK_ID = LOCK_ID+1, UPDATE_USER_TX = 'INC0249459'
WHERE   ID IN ( 33694415  )
