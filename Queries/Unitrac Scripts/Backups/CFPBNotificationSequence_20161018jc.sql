...
/****** Object:  StoredProcedure [dbo].[Report_CFPBNotificationSequence]    Script Date: 10/18/2016 4:56:44 PM ******/
DECLARE
...
SET @Branch = NULL
SET @Division = NULL
SET @GroupByCode = 'Brch'
SET @Coverage = 'HAZARD'
SET @ReportConfig = 'CFPB_NOTIFSEQ'
SET @SortByCode = 'LoanNumber'
SET @FilterByCode = ''
SET @ProcessLogID = '38422074'
SET @ReportType = 'CFPB_NOTIFSEQ'
SET @LenderCode = '2982'
