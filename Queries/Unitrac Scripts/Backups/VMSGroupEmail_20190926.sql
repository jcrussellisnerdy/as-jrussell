...
/****** Object:  StoredProcedure [dbo].[VMSGroupEmail]    Script Date: 9/26/2019 4:25:38 PM ******/
SET ANSI_NULLS ON
GO
...
CREATE  PROCEDURE [dbo].[VMSGroupEmail] (@gname as varchar(20), @body as varchar(6000), @attachment as varchar(1000)=NULL )AS
