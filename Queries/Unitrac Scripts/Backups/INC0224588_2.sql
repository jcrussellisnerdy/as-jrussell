...
UPDATE_DT = GETDATE() , UPDATE_USER_TX = 'INC0224588' , 
...
FROM dbo.PROPERTY_CHANGE
	WHERE ENTITY_NAME_TX = 'Allied.UniTrac.RequiredCoverage' AND USER_TX = 'INC0XXXXXX'
	AND CREATE_DT >= '2016-03-10'


UPDATE dbo.PROPERTY_CHANGE
SET USER_TX = 'INC0224588'
