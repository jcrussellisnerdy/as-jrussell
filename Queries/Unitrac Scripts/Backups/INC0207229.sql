SELECT * 
--INTO UniTracHDStorage..INC0207229
FROM dbo.WORK_ITEM
WHERE ID IN (26714901,
26857260,
26857261,
26984299,
27113824,
...
SELECT * FROM UniTracHDStorage..INC0207229
...
WHERE   WORKFLOW_DEFINITION_ID = 11
        ...
        AND ID IN ( SELECT ID FROM UniTracHDStorage..INC0207229 )
...
SELECT * INTO #TMP_ESCROW_04 FROM #TMP_ESCROW WHERE USER_ACTION = ''
