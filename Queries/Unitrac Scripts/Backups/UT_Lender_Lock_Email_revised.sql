...
alter  PROCEDURE [dbo].[UT_Lender_Lock_Email] (@body as varchar(6000), @attachment as varchar(1000)=NULL )AS
...
@eto = 'joseph.russell@alliedsolutions.net, Meghan.Hartje@Alliedsolutions.net, Leonel.Aguayo@Alliedsolutions.net, Lindsey.Cusson@Ospreyss.com'
