...
WHERE   WORKFLOW_DEFINITION_ID = 11
        ...
        AND ID IN ( 29254657, 32711278, 32751484, 32767848, 32780921, 32781431, 32781600, 32792546, 32800746, 32803557, 32803594, 32826290, 32848045, 32850540, 32851281, 32863127 , 32880107  )
