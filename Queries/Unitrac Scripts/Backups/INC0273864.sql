...
WHERE   ID IN ( SELECT ID FROM UniTracHDStorage..INC0273864 )



UPDATE WI SET STATUS_CD = 'Withdrawn' , 
UPDATE_DT = GETDATE() , UPDATE_USER_TX = 'INC0273864' , 
...
CURRENT_OWNER_ID , 'INC0273864' , 'Y' , GETDATE() , GETDATE() , 'INC0273864' , 1 , 1
FROM #TMPWI
ORDER BY STATUS_CD
---- 
