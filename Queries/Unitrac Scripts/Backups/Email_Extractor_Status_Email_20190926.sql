...
/****** Object:  StoredProcedure [dbo].[Email_Extractor_Status_Email]    Script Date: 9/26/2019 4:02:12 PM ******/
SET ANSI_NULLS ON
GO
...
CREATE  PROCEDURE [dbo].[Email_Extractor_Status_Email] (@body as varchar(6000), @attachment as varchar(1000)=NULL )AS
...
@eto = 'Tom.Elliott@alliedsolutions.net, Julie.Culler@Alliedsolutions.net, Jalana.Baugh@Alliedsolutions.net, Sherry.Turner@Alliedsolutions.net,Mike.Breitsch@alliedsolutions.net'
