...
SELECT  *
--INTO UniTracHDStorage..INC0281082
FROM    UniTrac..WORK_ITEM
WHERE   ID IN ( 36745358 , 36791701 )
...
--        LOCK_ID = LOCK_ID + 1 ,
--        UPDATE_DT = GETDATE() ,
--        UPDATE_USER_TX = 'INC0281082'
--WHERE   ID IN ( SELECT ID FROM UniTracHDStorage..INC0281082 )
