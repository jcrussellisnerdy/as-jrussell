...
/****************************************************************************************** 
   ...
   *Revision History
   - 31-Jul-2011 (Rodrigo S): Initial development
   - 12-Apr-2012 (Rodrigo S): Enhanced sql_text, object_name outputs;
								  Added NOLOCK hints and RECOMPILE option;
								  Added BlkBy column;
								  Removed dead-code.
   - 03-Nov-2014 (Rodrigo S): Added program_name and open_transaction_count	column
   - 10-Nov-2014 (Rodrigo S): Added granted_memory_GB
*******************************************************************************************/
BEGIN
SET NOCOUNT ON;
	SELECT r.session_id,
