...
SELECT CONTENT_XML.value('(/Content/Lender/Code)[1]', 'varchar (50)') Lender, * INTO UniTracHDStorage..WI_INC0219140
FROM    UniTrac..WORK_ITEM
WHERE   ID IN ( 27092792   )
...
WHERE   LENDER.CODE_TX = '6096'
		...
		AND WI.ID IN (27092792)
		
SELECT * FROM #TMPWI

SELECT * INTO UniTracHDStorage..LOAN_INC0219140
