...
WHERE LENDER_ID in (select id from #tmpLender) AND PAYEE_CODE_TX in ('2149')
...
UPDATE LPCM
SET PURGE_DT = GETDATE(), UPDATE_DT = GETDATE(),UPDATE_USER_TX = 'INC0413370', LOCK_ID = LOCK_ID + 1
--SELECT *
FROM LENDER_PAYEE_CODE_MATCH LPCM
