/****** Object:  StoredProcedure [dbo].[Report_CPIFalsePlaced]    Script Date: 06/17/2014 13:29:15 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Report_CPIFalsePlaced]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[Report_CPIFalsePlaced]
GO

/****** Object:  StoredProcedure [dbo].[Report_CPIFalsePlaced]    Script Date: 06/12/2014 13:29:15 ******/
SET ANSI_NULLS ON
GO
