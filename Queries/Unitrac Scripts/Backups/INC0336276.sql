...
WHERE   WI.ID IN (  38640176, 38880900, 39133740, 39744686, 40500837, 41007868   )
...
SELECT * INTO UniTracHDStorage..LOAN_INC0336276
FROM dbo.LOAN WHERE ID IN (SELECT LOAN_ID FROM #TMPWI)

SELECT * INTO UniTracHDStorage..WI_INC0336276
