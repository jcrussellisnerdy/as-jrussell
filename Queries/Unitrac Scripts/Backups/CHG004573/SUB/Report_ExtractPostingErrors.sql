/****** Object:  StoredProcedure [dbo].[Report_ExtractPostingErrors]     ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Report_ExtractPostingErrors]') AND type IN (N'P', N'PC'))
DROP PROCEDURE [dbo].[Report_ExtractPostingErrors]
GO


/****** Object:  StoredProcedure [dbo].[Report_ExtractPostingErrors]    Script Date: 7/2/2014 10:04:42 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO

CREATE PROCEDURE [dbo].[Report_ExtractPostingErrors] 
(	
