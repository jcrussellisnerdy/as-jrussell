/****** Object:  StoredProcedure [dbo].[Report_ExtractNewCollContract]     ******/
...
/****** Object:  StoredProcedure [dbo].[Report_ExtractNewCollContract]    Script Date: 12/09/2014 15:04:42 ******/
SET ANSI_NULLS ON
GO
...
--needs to be multiline
 ...
 @WorkItemID as [WORK_ITEM_ID],
  L.OFFICER_CODE_TX AS [LOAN_OFFICER_CODE_TX]
