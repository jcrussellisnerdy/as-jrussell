...
SELECT * --INTO UniTracHDStorage..INC0217401
FROM UniTrac..WORK_ITEM
WHERE CONTENT_XML.value('(/Content/Lender/Code)[1]', 'varchar (50)') = '010100'
...
UPDATE  UniTrac..WORK_ITEM
SET     STATUS_CD = 'Complete' ,
        UPDATE_USER_TX = 'INC0217401'
WHERE   ID IN ( SELECT ID FROm UniTracHDStorage..INC0217401 )
...
WHERE   LENDER.CODE_TX = '010100'
		...
		SELECT RECORD_TYPE_CD, PURGE_DT, * FROM dbo.LOAN
		WHERE ID IN (84471086)

SELECT * FROM #TMPWI

SELECT * from UniTracHDStorage..LOAN_INC0217401
