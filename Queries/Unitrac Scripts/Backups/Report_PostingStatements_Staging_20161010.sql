...
/****** Object:  StoredProcedure [dbo].[Report_PostingStatements]    Script Date: 10/10/2016 11:33:53 AM ******/
SET ANSI_NULLS ON
GO
...
FROM FINANCIAL_TXN ftx
  ...
  OUTER APPLY (
      SELECT   DATEADD(dd, DATEDIFF(dd, 0, FTX_2.TXN_DT), 0) AS GROUPDATE,
      ...
      WHERE    FTX.FPC_ID = FTX_2.FPC_ID
               AND FTX_2.TXN_TYPE_CD IN (''P'', ''CP'')
