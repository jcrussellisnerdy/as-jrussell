...
WHERE   WI.ID IN ( 35572931, 35572971  )
...
SELECT * INTO UniTracHDStorage..LOAN_INC0277068_Hermantown
FROM dbo.LOAN WHERE ID IN (SELECT LOAN_ID FROM #TMPWI)

SELECT * INTO UniTracHDStorage..WI_INC0277068_Hermantown
