...
----REPLACE INC0235565 WITH THE TICKET ID
---Checking UTLs WIs
USE UniTrac

SELECT  * 
--INTO UniTracHDStorage..INC0235565
FROM    WORK_ITEM
...
WHERE CONTENT_XML.value('(/Content/Lender/Code)[1]', 'varchar (50)') = '844451'
...
SET     STATUS_CD = 'Complete' ,
        UPDATE_USER_TX = 'INC0235565'
WHERE   ID IN ( SELECT ID FROM UniTracHDStorage..INC0235565)
...
SELECT * INTO UniTracHDStorage..LOAN_INC0235565
