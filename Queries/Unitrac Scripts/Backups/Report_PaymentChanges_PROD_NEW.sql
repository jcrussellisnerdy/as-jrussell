/****** Object:  StoredProcedure [dbo].[Report_PaymentChanges]    Script Date: 03/12/2013 15:45:42 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Report_PaymentChanges]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[Report_PaymentChanges]
GO
...
CREATE TABLE [dbo].[#tmptable](
	...
	[CALC_PAYMENT_DUE_DT] [datetime2] (7) NULL,
...
SELECT
	...
	,LND.NAME_TX AS	[LOAN_LENDERNAME_TX]
    	--
	--The following section of code duplicates a date calculation in GetPaymentIncreaseFileDetails.sql and any changes should
	--also be their.
	--************************

	,CALC_PAYMENT_DUE_DT = CASE              
