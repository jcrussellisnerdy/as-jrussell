...
SELECT * --INTO UniTracHDStorage..INC0221360
FROM UniTrac..WORK_ITEM
WHERE CONTENT_XML.value('(/Content/Lender/Code)[1]', 'varchar (50)') = '6483'
...
SET     STATUS_CD = 'Complete' ,
        UPDATE_USER_TX = 'INC0221360',
		 LOCK_ID = CASE WHEN LOCK_ID >= 255 THEN 1
                  ELSE LOCK_ID + 1 END
WHERE   ID IN  ( 29468091,4497915)
...
----                WHERE   UPDATE_USER_TX = 'INC0######' AND CODE_TX = '6483')
