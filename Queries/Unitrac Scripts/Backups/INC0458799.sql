...
where id in (60075564 )


select * from message
where id in (22745049)



--0.5) Verify Import Data Looks Correct
SELECT *
FROM UnitracHDStorage..INC0458799
...
GETDATE(), GETDATE(),'INC0458799',1
FROM UnitracHDStorage..INC0458799 pc
--39143
...
AND AD.UPDATE_USER_TX = 'INC0458799' AND AD.UPDATE_DT = GETDATE()
--48976
...
SELECT fullname,'',Replace([primary_ phone],'-',''),email_businesstype,'Y',GETDATE(),GETDATE(),'INC0458799',1,1,AD.ID,'N','N',NPN
FROM UnitracHDStorage..INC0458799 pc
LEFT JOIN ADDRESS ad ON pc.Primary_Address1 = ad.line_1_TX
and IsNull(pc.Primary_Address2,'') = IsNull(ad.line_2_TX,'')
and pc.Primary_City = ad.CITy_TX
...
--select *
from address a 
where update_user_tx = 'INC0458799'
