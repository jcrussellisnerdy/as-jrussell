...
SELECT  *
INTO UniTracHDStorage..INC0249293
FROM    UniTrac..WORK_ITEM
WHERE   ID IN (28666762, 28893086,29208666,28755939,28755092,28755198,28755199)
...
--        LOCK_ID = LOCK_ID + 1 ,
--        UPDATE_DT = GETDATE() ,
--        UPDATE_USER_TX = 'INC0249293'
--WHERE   ID IN ( SELECT ID FROM UniTracHDStorage..INC0249293 )
