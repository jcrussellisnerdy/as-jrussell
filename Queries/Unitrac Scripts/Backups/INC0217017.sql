...
WHERE   WORKFLOW_DEFINITION_ID = 11
      --  AND STATUS_CD = 'INITIAL'
        AND ID IN ( 28610085, 28702912, 28712398, 28744506 , 28753218  )
--AND CONTENT_XML.value('(/Content/Lender/Code)[1]' , 'varchar(10)') = '2771'
-----
--SELECT * FROM dbo.USERS
--WHERE UPDATE_USER_TX = 'jwilbanks'

SELECT * FROM dbo.PROCESS_LOG
WHERE ID IN (29561271)

SELECT * FROM dbo.PROCESS_LOG_ITEM
WHERE PROCESS_LOG_ID IN (29561271)
...
--SELECT  
--        *
--from UniTracHDStorage..INC0217017
--FROM    #TMPWI

SELECT * FROM WORK_ITEM_PROCESS_LOG_ITEM_RELATE WIPLIR
WHERE WORK_ITEM_ID = '28610085' 			 
-- JOIN PROCESS_LOG_ITEM PLI ON PLI.ID = WIPLIR.PROCESS_LOG_ITEM_ID	
 ...
 WHERE WIPLIR.WORK_ITEM_ID IN (
28610085)


SELECT * FROM dbo.WORK_ITEM
WHERE ID IN (28610085)

SELECT * FROM dbo.WORK_ITEM_ACTION
WHERE ID IN (60137681)

SELECT * FROM dbo.PROCESS_LOG_ITEM
WHERE PROCESS_LOG_ID IN (29561271) AND CAST(UPDATE_DT AS DATE) = CAST(GETDATE()-12 AS DATE)

SELECT * FROM dbo.WORK_ITEM_PROCESS_LOG_ITEM_RELATE
WHERE --PROCESS_LOG_ITEM_ID IN (29561271)
CAST(UPDATE_DT AS DATE) = CAST(GETDATE()-12 AS DATE)
