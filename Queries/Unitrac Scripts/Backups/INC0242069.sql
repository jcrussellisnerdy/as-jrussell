...
SELECT DISTINCT C.FIELD_PROTECTION_XML.value( '(/FP/Field/@name)[1]', 'varchar(500)' )[Retained]
,R.TYPE_CD [Coverage Type], L.NUMBER_TX ,
...
WHERE   L.LENDER_ID = '200' AND  C.FIELD_PROTECTION_XML IS NOT NULL AND R.TYPE_CD = 'FLOOD'
