...
SELECT * 
--INTO UniTracHDStorage..INC0242978
FROM UniTrac..WORK_ITEM
WHERE ID IN (32879665)
...
VALUES  ( 32879665 , -- WORK_ITEM_ID - bigint
...
WHERE WORK_ITEM_ID = '32879665'


----Use Last WIA ID that was created for LAST_WORK_ITEM_ACTION_ID column 
UPDATE  UniTrac..WORK_ITEM
SET     STATUS_CD = 'Complete', LAST_WORK_ITEM_ACTION_ID = '68857592', 
UPDATE_DT = GETDATE(),LOCK_ID = LOCK_ID+1, UPDATE_USER_TX = 'INC0242978'
WHERE   ID IN ( 32879665 )
