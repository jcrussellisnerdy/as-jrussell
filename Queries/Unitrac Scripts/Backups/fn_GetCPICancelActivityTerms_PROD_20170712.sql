...
/****** Object:  UserDefinedFunction [dbo].[fn_GetCPICancelActivityTerms]    Script Date: 7/12/2017 2:06:55 PM ******/
SET ANSI_NULLS ON
GO
...
BEGIN
   ...
   BEGIN 
      ...
      begin  
         ...
         insert into @OUTPUT
         select   @FPC_ID, T.START_TERM_NO, ftx.AMOUNT_NO, prd.PERIOD_START_DT, prd.PERIOD_END_DT 
         from     @CPI_TERM_PERIODS T
