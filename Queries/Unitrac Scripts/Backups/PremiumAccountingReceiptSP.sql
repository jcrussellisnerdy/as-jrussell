...
--/****** Object:  StoredProcedure [dbo].[Report_PremiumAccountingReceipt]    Script Date: 11/18/2015 11:51:30 AM ******/
--DROP PROCEDURE [dbo].[Report_PremiumAccountingReceipt]
--GO
...
declare @work_item_id as bigint=27764212
...
INSERT INTO @TEMPVAR
EXEC dbo.CPGetBillingGroupDetails_new @id = @work_item_id, @Skip = 0, @Take = 0, @ReturnRefunds = 2, @OnlyNewFTA = 0, @LenderRoleOnly = 0;
