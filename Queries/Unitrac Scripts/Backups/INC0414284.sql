...
WHERE  WI.ID IN ( 50054066) AND WI.STATUS_CD NOT IN ( 'COMPLETE', 'Withdrawn' )
...
SELECT * INTO UniTracHDStorage..LOAN_INC0414284
FROM dbo.LOAN WHERE ID IN (SELECT LOAN_ID FROM #TMPWI)

SELECT * INTO UniTracHDStorage..WI_INC0414284
