...
/****** Object:  StoredProcedure [dbo].[GetPaymentIncreaseFileDetails]    Script Date: 5/26/2016 4:35:10 PM ******/
SET ANSI_NULLS ON
GO
...
BEGIN	
	...
	ISNULL(LOAN.NEXT_SCHEDULED_PAYMENT_DT ,'') AS NEXT_SCHEDULED_PAYMENT_DT ,
