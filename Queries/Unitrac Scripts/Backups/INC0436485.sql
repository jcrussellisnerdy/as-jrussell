...
WHERE  WI.ID IN ( 54434654 , 54434667) AND WI.STATUS_CD NOT IN ( 'COMPLETE', 'Withdrawn' )
...
SELECT * INTO UniTracHDStorage..LOAN_INC0436485
FROM dbo.LOAN WHERE ID IN (SELECT LOAN_ID FROM #TMPWI)

SELECT * INTO UniTracHDStorage..WI_INC0436485
