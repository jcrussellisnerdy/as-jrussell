/****** Object:  StoredProcedure [dbo].[Report_BillingStatements]     ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Report_BillingStatements]') AND type IN (N'P', N'PC'))
   DROP PROCEDURE [dbo].[Report_BillingStatements]
GO
