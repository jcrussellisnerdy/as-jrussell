...
/****** Object:  UserDefinedFunction [dbo].[fnGetInteractionHistory]    Script Date: 11/14/2017 8:22:38 PM ******/
SET ANSI_NULLS ON
GO
...
CREATE FUNCTION [dbo].[fnGetInteractionHistory] (
	@Id BIGINT = NULL
	,@loanId BIGINT = NULL
			...
			WHERE EXISTS (
					...
					WHERE ih.CREATE_DT < @startDate
						...
						AND (
							...
							OR ih.SPECIAL_HANDLING_XML.value('(/SH/SubResolutionCode)[1]', 'varchar(10)') in ('V', 'PV')
