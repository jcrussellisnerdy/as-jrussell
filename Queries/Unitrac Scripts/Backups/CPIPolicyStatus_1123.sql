...
--/****** Object:  StoredProcedure [dbo].[Report_CPIPolicyStatus]    Script Date: 11/23/2015 1:58:57 PM ******/
...
/*
--the following is somewhat more readable/understandable:
*/
1 = CASE
	WHEN RC.SUMMARY_SUB_STATUS_CD <> 'C' THEN 1
	
	WHEN RL.[Count] > 1 AND FPC.ID IS NOT NULL THEN 1
...
AND (L.BRANCH_CODE_TX IN (SELECT STRVALUE FROM @BranchTable) or @Branch = '1' or @Branch = '' or @Branch is NULL OR @Branch = 'ALL')
