...
SELECT * INTO UniTracHDStorage..LOAN_INC0277068_Dakotaland
FROM dbo.LOAN WHERE ID IN (SELECT LOAN_ID FROM #TMPWI)

SELECT * INTO UniTracHDStorage..WI_INC0277068_Dakotaland
