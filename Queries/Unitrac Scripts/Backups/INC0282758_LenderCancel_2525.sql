...
----REPLACE 2525 WITH THE THE Lender ID
----REPLACE INC0282758 WITH THE TICKET ID
---Checking UTLs WIs
USE UniTrac

--SELECT * FROM dbo.LENDER WHERE CODE_TX IN ('2525')
...
SET     STATUS_CD = 'Complete' ,
        UPDATE_USER_TX = 'INC0282758',
		 LOCK_ID = CASE WHEN LOCK_ID >= 255 THEN 1
                  ELSE LOCK_ID + 1 END
WHERE   ID IN  (  SELECT ID FROM UniTracHDStorage..INC0282758)
...
SELECT * INTO UniTracHDStorage..LOAN_INC0282758
