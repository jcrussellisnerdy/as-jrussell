USE [UniTrac]
GO
/****** Object:  StoredProcedure [dbo].[Report_Escrow]    Script Date: 5/10/2017 1:37:50 PM ******/
SET ANSI_NULLS ON
GO
...
BEGIN
	...
	FROM WORK_ITEM_PROCESS_LOG_ITEM_RELATE WIPLIR 
		Join PROCESS_LOG_ITEM PLI ON WIPLIR.PROCESS_LOG_ITEM_ID = PLI.ID and PLI.RELATE_TYPE_CD = 'Allied.UniTrac.Escrow' and PLI.Purge_DT IS NULL
		Join ESCROW E on PLI.RELATE_ID = E.ID AND E.PURGE_DT IS NULL AND E.REPORTED_DT IS NOT NULL
	WHERE WIPLIR.WORK_ITEM_ID = 39102612 AND WIPLIR.PURGE_DT IS NULL 
	and (E.REPORTED_DT BETWEEN '2017-05-05T00:50:07' and '2017-05-08T09:55:40')
	SET @RecordTypeCode = 'G'
END
...
SELECT * FROM jcs..tahsha
WHERE LOAN_BRANCHCODE_TX <> 'ESCROW'
