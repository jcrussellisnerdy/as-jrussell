...
SELECT CONTENT_XML.value('(/Content/Lender/Code)[1]', 'varchar (50)') Lender, * --INTO UniTracHDStorage..WI_INC0218324
FROM    UniTrac..WORK_ITEM
WHERE   ID IN ( 27918718   )
...
WHERE   LENDER.CODE_TX = '5660'
		...
		AND WI.ID IN (27918718 )
		
SELECT * FROM #TMPWI

SELECT * INTO UniTracHDStorage..LOAN_INC0218324
