...
SELECT  *
INTO UniTracHDStorage..INC0312810
FROM    UniTrac..WORK_ITEM
WHERE   ID IN (40839818 )
...
--        LOCK_ID = LOCK_ID + 1 ,
--        UPDATE_DT = GETDATE() ,
--        UPDATE_USER_TX = 'INC0312810'
--WHERE   ID IN ( SELECT ID FROM UniTracHDStorage..INC0312810 )
