...
SELECT *
--INTO UniTracHDStorage..INC0228314
 FROM UniTrac..WORK_ITEM
WHERE CONTENT_XML.value('(/Content/Lender/Code)[1]', 'varchar (50)') = '7512'
...
SET     STATUS_CD = 'Complete' ,
        UPDATE_USER_TX = 'INC0228314',
		 LOCK_ID = CASE WHEN LOCK_ID >= 255 THEN 1
                  ELSE LOCK_ID + 1 END
WHERE   ID IN  ( SELECT ID FROM UniTracHDStorage..INC0228314 )
