...
SELECT  *
INTO UniTracHDStorage..INC0328776
FROM    UniTrac..WORK_ITEM
WHERE   ID IN (42488409, 42512517, 42487970, 42412964, 42455431 )
...
SET     STATUS_CD = 'Complete' ,
        LOCK_ID = LOCK_ID + 1 ,
        UPDATE_DT = GETDATE() ,
        UPDATE_USER_TX = 'INC0328776'
WHERE   ID IN ( SELECT ID FROM UniTracHDStorage..INC0328776 )
