...
SELECT * 
INTO UniTracHDStorage..INC0250684
FROM UniTrac..WORK_ITEM
WHERE ID IN (33693873)
...
VALUES  ( 33693873 , -- WORK_ITEM_ID - bigint
          ...
          N'INC0250684' , -- UPDATE_USER_TX - nvarchar(15)
          1 , -- LOCK_ID - tinyint
...
LAST_WORK_ITEM_ACTION_ID = (SELECT MAX(ID) FROM dbo.WORK_ITEM_ACTION WHERE   WORK_ITEM_ID IN ( 33693873 )),
UPDATE_DT = GETDATE(),LOCK_ID = LOCK_ID+1, UPDATE_USER_TX = 'INC0250684'
WHERE   ID IN ( 33693873 )
