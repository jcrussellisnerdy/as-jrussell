...
SELECT CONTENT_XML.value('(/Content/Lender/Code)[1]', 'varchar (50)') Lender, * --INTO UniTracHDStorage..WI_INC0218578
FROM    UniTrac..WORK_ITEM
WHERE   ID IN ( 27803230  )
...
WHERE   LENDER.CODE_TX = '6554'
       ...
       -- AND WI.CREATE_DT < '2014-01-01 00:00:00.000'
		...
		AND WI.ID IN (27803230)
		
SELECT * FROM #TMPWI

SELECT * INTO UniTracHDStorage..LOAN_INC0218578
