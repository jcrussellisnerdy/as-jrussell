...
--51467817 in all places is the WORK_ITEM_ID
...
VALUES  ( 51467817 , -- WORK_ITEM_ID - bigint
         ...
         1 , -- CURRENT_QUEUE_ID - bigint
          ...
          N'per user AaronUrbanski' , -- ACTION_NOTE_TX - nvarchar(1000)
          'Y' , -- ACTIVE_IN - char(1)
          GETDATE() , -- CREATE_DT - datetime
         NULL , -- PURGE_DT - datetime
          GETDATE() , -- UPDATE_DT - datetime
          N'INC0388880' , -- UPDATE_USER_TX - nvarchar(15)
          1 , -- LOCK_ID - tinyint
...
LAST_WORK_ITEM_ACTION_ID = (SELECT MAX(ID) FROM dbo.WORK_ITEM_ACTION WHERE   WORK_ITEM_ID IN ( 51467817 )),
UPDATE_DT = GETDATE(),LOCK_ID = LOCK_ID+1, UPDATE_USER_TX = 'INC0388880'
--SELECT * FROM dbo.WORK_ITEM
WHERE   ID IN ( 51467817 )
        AND WORKFLOW_DEFINITION_ID = 1
        AND ACTIVE_IN = 'Y'


		update wia
		set UPDATE_USER_TX = 'INC0388880'
		--select *
		from WORK_ITEM_ACTION wia
		where WORK_ITEM_id in (51467817 )
		and id = 106487855