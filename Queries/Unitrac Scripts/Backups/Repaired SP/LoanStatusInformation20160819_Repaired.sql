...
/****** Object:  StoredProcedure [dbo].[Report_LoanStatus]    Script Date: 8/19/2016 8:01:48 AM ******/
SET ANSI_NULLS ON
GO
...
--COVERAGE:
	...
	[IMPAIRMENT_CODE_TX] [nvarchar](max) NULL,
	[IMPAIRMENT_MEANING_TX] [nvarchar](max) NULL,
...
/**/
DECLARE @MultImpair TABLE(REQUIREDCOVERAGE_ID BigInt NOT NULL, IMPAIRMENT_CODE_TX nvarchar(max) NULL, IMPAIRMENT_MEANING_TX nvarchar(max) NULL)
...
*/
	...
	cross apply(
		select WithLoans = stuff(
			(select ', '
			 + l.number_tx
			 /*+ case when c.STATUS_CD in ('A','U') then '' else '(' + c.status_cd + ')' end*/
