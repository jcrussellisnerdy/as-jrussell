SELECT  * --INTO UniTracHDStorage..INC0212066
FROM    dbo.WORK_ITEM
WHERE   ID IN ( 27698414, 27289175, 27648590, 27650809, 27660521, 27673884,
                27674476, 27679376, 27681953, 27687708, 27701448, 27708109,
                27720705, 27760253, 27762350, 27764106, 27785010, 27795570,
                27811021, 27818371, 27832141 )

SELECT * FROM dbo.USERS
WHERE USER_NAME_TX = 'sherren'
