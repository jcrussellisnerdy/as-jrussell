...
SELECT L.ID,  L.SPECIAL_HANDLING_XML FROM LOAN L
...
WHERE LL.CODE_TX IN ('2771') AND L.NUMBER_TX IN ('1212213640')


SELECT * FROM dbo.REQUIRED_ESCROW
WHERE REQUIRED_COVERAGE_ID IN (39453952,
75110242,
39453949,
39453949,
39453952,
...
WHERE LOAN_ID IN (67118577, 169453329,
178049718)
...
SELECT * INTO UniTracHDStorage..LOAN_INC0312813
FROM dbo.LOAN WHERE ID IN (SELECT LOAN_ID FROM #TMPWI)

SELECT * INTO UniTracHDStorage..WI_INC0312813
