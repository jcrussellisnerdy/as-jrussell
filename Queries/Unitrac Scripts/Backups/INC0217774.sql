...
SELECT CONTENT_XML.value('(/Content/Lender/Code)[1]', 'varchar (50)') Lender, * INTO UniTracHDStorage..WI_INC0217774
FROM    UniTrac..WORK_ITEM
WHERE   ID IN (  24673761 , 25641281  )
...
WHERE   LENDER.CODE_TX = '1994'
		...
		AND WI.ID IN (24673761 , 25641281)
		
SELECT * FROM #TMPWI

SELECT * INTO UniTracHDStorage..LOAN_INC0217774
