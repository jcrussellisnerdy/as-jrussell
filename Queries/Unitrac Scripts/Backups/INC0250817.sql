...
SELECT  *
INTO UniTracHDStorage..INC0250817
FROM    UniTrac..WORK_ITEM
WHERE   ID IN (34174262,34174903,34218770,34249495,34249502,34015853)
...
--        LOCK_ID = LOCK_ID + 1 ,
--        UPDATE_DT = GETDATE() ,
--        UPDATE_USER_TX = 'INC0250817'
--WHERE   ID IN ( SELECT ID FROM UniTracHDStorage..INC0250817 )
