...
SELECT * INTO UniTracHDStorage..INC0231685_loan_5 FROM dbo.LOAN
WHERE ID IN (SELECT LoanID FROM #tmpE)

SELECT * INTO UniTracHDStorage..INC0231685_OP_5
FROM dbo.OWNER_POLICY
WHERE ID IN (SELECT [OP_ID] FROM #tmpE)



SELECT * INTO UniTracHDStorage..INC0231685_RC_5
FROM dbo.REQUIRED_COVERAGE
WHERE ID IN (SELECT [RC_ID] FROM #tmpE)


SELECT * INTO UniTracHDStorage..INC0231685_IH_5
...
WHERE (OP.STATUS_CD = 'E' AND OP.SUB_STATUS_CD <>'R')
