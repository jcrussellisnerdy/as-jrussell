...
DECLARE @ldr_id2 AS BigInt
	SELECT @ldr_code1 = '2258'
	SELECT @ldr_code2 = '2258'
...
DECLARE @loan_num2 AS NVarChar(18)
	SELECT @loan_num1 = '1446040L50'
	SELECT @loan_num2 = '613'
...
update C
set
 PROPERTY_ID = 241816855, PRIMARY_LOAN_IN = 'Y', LOAN_PERCENTAGE_NO = 100, COLLATERAL_NUMBER_NO = 1
,UPDATE_DT = getdate()
,UPDATE_USER_TX = 'INC0376872'
,LOCK_ID = C.LOCK_ID % 255 + 1
from COLLATERAL as C
where C.ID = 144967622
...
,LOCK_ID = C.LOCK_ID % 255 + 1
from COLLATERAL as C
where C.ID = 243833228

EXEC SaveSearchFullText 124309771

EXEC SaveSearchFullText 241816855