...
LL.NAME_TX [Lender Name] ,
  LO.NAME_TX [Division],
      PD.TYPE_CD [Pre-Processing Details],
		...
		RD.VALUE_TX [Import Configurations] INTO JCs..INC0232840
		...
		LEFT JOIN dbo.CHANGE_UPDATE CU ON C.ID = CU.CHANGE_ID AND Cu.QUALIFIER_TX like '%Enable 1st Line of Insurance Processing%'AND CU.QUALIFIER_TX NOT LIKE '%Escrow%'
		LEFT JOIN dbo.LENDER_ORGANIZATION LO ON LO.LENDER_ID = LL.ID AND LO.TYPE_CD = 'DIV' 
