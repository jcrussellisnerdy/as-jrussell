...
SELECT  TP.EXTERNAL_ID_TX  [Lender Code] ,
	   ...
	   LO.NAME_TX [Division],
		...
		INNER JOIN RELATED_DATA RDD ON LO.ID = RDD.RELATE_ID  --AND RDD.COMMENT_TX LIKE '%UniTracDeliveryType%'
