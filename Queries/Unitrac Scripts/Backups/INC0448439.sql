...
SELECT  *
INTO UniTracHDStorage..INC0448439_workitem_2
FROM    UniTrac..WORK_ITEM
WHERE   ID IN (58236229, 58500432, 58236524 )
...
select * from UniTracHDStorage..RepoPlusRecovery_Reza2
...
SET     STATUS_CD = 'Complete' ,
        LOCK_ID = LOCK_ID + 1 ,
        UPDATE_DT = GETDATE() ,
        UPDATE_USER_TX = 'INC0448439'
WHERE   ID IN ( SELECT ID FROM UniTracHDStorage..INC0448439_workitem_2 )
