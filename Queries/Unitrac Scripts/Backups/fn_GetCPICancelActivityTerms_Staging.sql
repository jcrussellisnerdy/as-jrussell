...
/****** Object:  UserDefinedFunction [dbo].[fn_GetCPICancelActivityTerms]    Script Date: 7/14/2017 9:04:51 AM ******/
SET ANSI_NULLS ON
GO
...
ALTER FUNCTION [dbo].[fn_GetCPICancelActivityTerms] (@FPC_ID BIGINT, @BillingGroupId BIGINT)
