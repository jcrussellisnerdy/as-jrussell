...
/****** Object:  StoredProcedure [dbo].[Report_PreEscrow]    Script Date: 6/11/2018 9:57:11 AM ******/
SET ANSI_NULLS ON
GO
...
where RE.ACTIVE_IN = 'Y' 
  ...
  And RE.purge_dt is null
  and ((E.END_DT <= DATEADD(d, ISNULL(th.RCEscrowCollectionTimeWindow,0), GETDATE())) OR (E.END_DT is null) )
