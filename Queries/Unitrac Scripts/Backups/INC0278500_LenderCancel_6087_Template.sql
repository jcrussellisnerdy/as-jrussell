...
----REPLACE 6087 WITH THE THE Lender ID
----REPLACE INC0278500 WITH THE TICKET ID
---Checking UTLs WIs
USE UniTrac

--SELECT * FROM dbo.LENDER WHERE CODE_TX IN ('6087')
...
SET     STATUS_CD = 'Complete' ,
        UPDATE_USER_TX = 'INC0278500',
		 LOCK_ID = CASE WHEN LOCK_ID >= 255 THEN 1
                  ELSE LOCK_ID + 1 END
WHERE   ID IN  (  SELECT ID FROM UniTracHDStorage..INC0278500)
...
SELECT * INTO UniTracHDStorage..LOAN_INC0278500
