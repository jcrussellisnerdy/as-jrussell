...
'<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xslHelper="urn:xslHelper" xmlns:msxsl="urn:schemas-microsoft-com:xslt" xmlns:FormatInsurance="urn:custom-scripts-csharp" version="1.0">
   ...
   <xsl:template match="Loan">
      ...
      <!-- 01: Lender # -->
      <xsl:choose>
         <xsl:when test="xslHelper:GetCompanyPayeeCd(Colls/Coll[@id=$CollID]/Cvgs/Cvg[@id=$ReqCovID]/@escrowIn, Colls/Coll[@id=$CollID]/Cvgs/Cvg[@id=$ReqCovID]/@fpcInd, Colls/Coll[@id=$CollID]/Cvgs/Cvg[@id=$ReqCovID]/Plcys/Plcy[@id=$PlcyID]/@bicID, @num, Colls/Coll[@id=$CollID]/@line1, Colls/Coll[@id=$CollID]/Cvgs/Cvg[@id=$ReqCovID]/@typ, Colls/Coll[@id=$CollID]/Cvgs/Cvg[@id=$ReqCovID]/Plcys/Plcy[@id=$PlcyID]/@num, Colls/Coll[@id=$CollID]/Cvgs/Cvg[@id=$ReqCovID]/Plcys/Plcy[@id=$PlcyID]/@bicName)=''        ''">
            <!--SKIP -->
         </xsl:when>
         <xsl:otherwise>
            ...
            <xsl:value-of select="xslHelper:GetCompanyPayeeCd(Colls/Coll[@id=$CollID]/Cvgs/Cvg[@id=$ReqCovID]/@escrowIn, Colls/Coll[@id=$CollID]/Cvgs/Cvg[@id=$ReqCovID]/@fpcInd, Colls/Coll[@id=$CollID]/Cvgs/Cvg[@id=$ReqCovID]/Plcys/Plcy[@id=$PlcyID]/@bicID, @num, Colls/Coll[@id=$CollID]/@line1, Colls/Coll[@id=$CollID]/Cvgs/Cvg[@id=$ReqCovID]/@typ, Colls/Coll[@id=$CollID]/Cvgs/Cvg[@id=$ReqCovID]/Plcys/Plcy[@id=$PlcyID]/@num, Colls/Coll[@id=$CollID]/Cvgs/Cvg[@id=$ReqCovID]/Plcys/Plcy[@id=$PlcyID]/@bicName)" />
            ...
            <xsl:choose>
               ...
               <xsl:when test="Colls/Coll[@id=$CollID]/Cvgs/Cvg[@id=$ReqCovID]/Plcys/Plcy[@id=$PlcyID]/@expDt">
            ...
            <!-- 170: Coverage Amount -->
            <xsl:choose>
               <xsl:when test="Colls/Coll[@id=$CollID]/Cvgs/Cvg[@id=$ReqCovID]/Plcys/Plcy[@id=$PlcyID]/PlcyCvgs/PlcyCvg/@covAmt">
                  <xsl:value-of select="FormatInsurance:FormatAmountWhole(Colls/Coll[@id=$CollID]/Cvgs/Cvg[@id=$ReqCovID]/Plcys/Plcy[@id=$PlcyID]/PlcyCvgs/PlcyCvg/@covAmt, 9)" />
               </xsl:when>
               <xsl:otherwise>
   ...
   <msxsl:script language="C#" implements-prefix="FormatInsurance">
      ...
      public string FormatAmountWhole(string value, int length)
      {
      if ((value == null) || (value == string.Empty))
      {
      value = "0";
      }
      value = Convert.ToDecimal(value).ToString("0").PadRight(length, '' '');

      if (value.Length &gt; length)
      {
      value = "9".PadRight(length, ''9'');
      }
      return value;
      }
   </msxsl:script>
