...
--SELECT  *
--INTO    UniTracHDStorage..PLIINC0228597
--FROM    dbo.PROCESS_LOG_ITEM
--WHERE   PROCESS_LOG_ID = '32479762'
--        AND PURGE_DT IS NOT NULL

--SELECT  *
--INTO    UniTracHDStorage..WIPLIRINC0228597
--FROM    dbo.WORK_ITEM_PROCESS_LOG_ITEM_RELATE
--WHERE   PROCESS_LOG_ITEM_ID IN ( 1177715351, 1177715355, 1177715350,
--                                 1177715352, 1177715354, 1177715356,
--                                 1177715353 )
...
UPDATE P
SET P.PURGE_DT = L.PURGE_DT, P.UPDATE_DT = GETDATE(), P.UPDATE_USER_TX = 'INC0228597', P.LOCK_ID = P.LOCK_ID+1
--SELECT * 
FROM dbo.PROCESS_LOG_ITEM P
INNER JOIN UniTracHDStorage..PLIINC0228597 L ON P.ID = L.ID
...
SET P.PURGE_DT = L.PURGE_DT, P.UPDATE_DT = GETDATE(), P.UPDATE_USER_TX = 'INC0228597', P.LOCK_ID = P.LOCK_ID+1
--SELECT * 
FROM  WORK_ITEM_PROCESS_LOG_ITEM_RELATE  P
INNER JOIN UniTracHDStorage..WIPLIRINC0228597 L ON P.ID = L.ID





UPDATE WORK_ITEM_PROCESS_LOG_ITEM_RELATE 
SET PURGE_DT = NULL, UPDATE_DT = GETDATE(), UPDATE_USER_TX = 'INC0228597', LOCK_ID = LOCK_ID+1
--SELECT * FROM WORK_ITEM_PROCESS_LOG_ITEM_RELATE 
WHERE   ID IN (SELECT ID FROM  UniTracHDStorage..WIPLIRINC0228597)