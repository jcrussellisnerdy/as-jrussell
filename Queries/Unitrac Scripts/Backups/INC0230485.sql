...
SELECT CONTENT_XML.value('(/Content/Lender/Code)[1]', 'varchar (50)') Lender, * INTO UniTracHDStorage..WI_INC0230485
FROM    UniTrac..WORK_ITEM
WHERE   ID IN ( 30778958 , 30779067)
...
SELECT * INTO UniTracHDStorage..LOAN_INC0230485
