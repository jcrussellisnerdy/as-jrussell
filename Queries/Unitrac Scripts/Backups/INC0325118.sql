...
SELECT  L.NUMBER_TX , L.PREDICTIVE_DECILE_NO, 
		...
		CONCAT(O.FIRST_NAME_TX, ' ', O.LAST_NAME_TX) AS [Customer Name],
        L.EFFECTIVE_DT         
INTO    JCs..INC0325118
FROM    LOAN L
		...
		WHERE LL.CODE_TX = '3181' AND L.RECORD_TYPE_CD IN ('G', 'A')	AND L.PREDICTIVE_DECILE_NO IN ('1', '2')
