...
SELECT * --INTO UniTracHDStorage..INC0210595
FROM dbo.WORK_ITEM
WHERE ID IN (27244652)
...
WHERE   ID IN ( SELECT ID FROM UniTracHDStorage..INC0210595)
...
WHERE   LENDER.CODE_TX = '6147'
		...
		AND WI.ID IN ( SELECT ID FROM UniTracHDStorage..INC0210595)
