...
WHERE CONTENT_XML.value('(/Content/Lender/Code)[1]', 'varchar (50)') = '1958'
...
--SELECT * INTO UniTracHDStorage..INC0205300 FROM UniTrac..WORK_ITEM
--WHERE CONTENT_XML.value('(/Content/Lender/Code)[1]', 'varchar (50)') = '1958'
--AND WORKFLOW_DEFINITION_ID IN (2,3,6,8)
----AND STATUS_CD = 'Initial'
--AND WORK_ITEM.STATUS_CD NOT LIKE 'Complete' AND WORK_ITEM.STATUS_CD NOT LIKE 'Withdrawn'
...
SELECT CONTENT_XML.value('(/Content/Lender/Code)[1]', 'varchar (50)'),* FROM UniTracHDStorage..INC0205300
...
UPDATE  UniTrac..WORK_ITEM
SET     STATUS_CD = 'Complete' ,
        UPDATE_USER_TX = 'INC0205300'
WHERE   ID IN ( 24616293 )
