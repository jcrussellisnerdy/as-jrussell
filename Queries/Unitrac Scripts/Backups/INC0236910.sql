...
WHERE   WORKFLOW_DEFINITION_ID = 11
        ...
        AND ID IN ( 31232921, 31692347, 31773383, 31823166, 31825000, 31826228, 31838356, 31852862, 31865451, 31876753, 31888063, 31895121, 31909344, 31922140, 31931819 , 31933072  )
