...
/****** Object:  StoredProcedure [dbo].[Report_BillingStatements]    Script Date: 8/17/2017 8:37:55 AM ******/
SET ANSI_NULLS ON
GO
...
BEGIN
   ...
   BEGIN
      ...
      SET      PRD_START_DT = ISNULL(C.PERIOD_START_DT, PRD_START_DT),
               PRD_END_DT = ISNULL(CASE WHEN PRD_END_DT < C.PERIOD_END_DT THEN PRD_END_DT ELSE C.PERIOD_END_DT END, PRD_END_DT), 
