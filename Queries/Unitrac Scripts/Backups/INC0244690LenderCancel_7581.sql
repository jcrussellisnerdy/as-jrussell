...
----REPLACE 7581 WITH THE THE Lender ID
----REPLACE INC0244690 WITH THE TICKET ID
---Checking UTLs WIs
USE UniTrac

SELECT  * 
--INTO UniTracHDStorage..INC0244690
FROM    WORK_ITEM
...
WHERE CONTENT_XML.value('(/Content/Lender/Code)[1]', 'varchar (50)') = '7581'
...
SET     STATUS_CD = 'Complete' ,
        UPDATE_USER_TX = 'INC0244690',
		 LOCK_ID = CASE WHEN LOCK_ID >= 255 THEN 1
                  ELSE LOCK_ID + 1 END
WHERE   ID IN  (  SELECT ID FROM UniTracHDStorage..INC0244690)
...
SELECT * INTO UniTracHDStorage..LOAN_INC0244690
