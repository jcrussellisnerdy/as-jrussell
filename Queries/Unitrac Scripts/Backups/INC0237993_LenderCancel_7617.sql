...
----REPLACE INC0237993 WITH THE TICKET ID
---Checking UTLs WIs
USE UniTrac

SELECT  * 
--INTO UniTracHDStorage..INC0237993
FROM    WORK_ITEM
...
WHERE CONTENT_XML.value('(/Content/Lender/Code)[1]', 'varchar (50)') = '7617'
...
SET     STATUS_CD = 'Complete' ,
        UPDATE_USER_TX = 'INC0237993',
		 LOCK_ID = CASE WHEN LOCK_ID >= 255 THEN 1
                  ELSE LOCK_ID + 1 END
WHERE   ID IN  (SELECT ID FROM UniTracHDStorage..INC0237993 )
...
SELECT * INTO UniTracHDStorage..LOAN_INC0237993
...
SELECT CONTENT_XML.value('(/Content/Lender/Code)[1]', 'varchar (50)') Lender, * --INTO UniTracHDStorage..WI_INC0237993
INTO    #TMPWI
FROM    UniTrac..WORK_ITEM
WHERE   ID IN ( 28879544,
28879557,
28879564  )
...
UPDATE_DT = GETDATE() , UPDATE_USER_TX = 'INC0237993' , 
...
CURRENT_OWNER_ID , 'INC0237993' , 'Y' , GETDATE() , GETDATE() , 'INC0237993' , 1 , 1
FROM #TMPWI
ORDER BY STATUS_CD
---- 
