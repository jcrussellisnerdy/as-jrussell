...
/****** Object:  StoredProcedure [dbo].[GetWorkItemsForAutoComplete]    Script Date: 11/6/2018 10:49:24 AM ******/
SET ANSI_NULLS ON
GO
...
BEGIN
	...
	AND wi.CONTENT_XML.value('(/Content/Cycle/IsAutoComplete)[1]', 'varchar(3)') = 'YES'
