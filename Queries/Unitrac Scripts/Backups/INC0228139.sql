...
SELECT CONTENT_XML.value('(/Content/Lender/Code)[1]', 'varchar (50)') Lender, * --INTO UniTracHDStorage..WI_INC0228139 
FROM    UniTrac..WORK_ITEM
WHERE ID IN (30368584, 30427477, 30427478)
...
WHERE   LENDER.CODE_TX = '6096'
		...
		AND WI.ID IN (30368584, 30427477, 30427478)
		
SELECT * FROM #TMPWI

SELECT * --INTO UniTracHDStorage..LOAN_INC0228139
