...
WHERE  WI.ID IN (53839886) AND WI.STATUS_CD NOT IN ( 'COMPLETE', 'Withdrawn' )
...
SELECT * INTO UniTracHDStorage..LOAN_INC0420424
FROM dbo.LOAN WHERE ID IN (SELECT LOAN_ID FROM #TMPWI)

SELECT * INTO UniTracHDStorage..WI_INC0420424
