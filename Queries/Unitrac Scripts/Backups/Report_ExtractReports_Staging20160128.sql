...
/****** Object:  StoredProcedure [dbo].[Report_ExtractReports]    Script Date: 1/28/2016 11:47:42 AM ******/
...
BEGIN
	...
	INSCOMPANY_POLICY_NO = (CASE WHEN T.INSCOMPANY_POLICY_NO IS NULL THEN w.BIC_NAME_TX ELSE T.INSCOMPANY_POLICY_NO END),
