...
/****** Object:  UserDefinedFunction [dbo].[GetQCInsuranceExpiredNotices]    Script Date: 4/4/2018 11:28:21 AM ******/
SET ANSI_NULLS ON
GO
...
BEGIN
	...
	AND cast(currCov.EXPIRATION_DT as DATE) != '12/31/9999'
	...
	FROM @tmpList tmp
		JOIN BORROWER_INSURANCE_COMPANY bic ON bic.ID = tmp.BIC_ID AND bic.PURGE_DT IS NULL
		JOIN BORROWER_INSURANCE_COMPANY_OFFERING bico ON bico.BORROWER_INSURANCE_COMPANY_ID = bic.ID AND bico.PURGE_DT IS NULL
