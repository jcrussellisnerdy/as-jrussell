...
WHERE   WORKFLOW_DEFINITION_ID = 11
        ...
        AND ID IN ( 32305252, 32302117, 32306166, 32320091, 32306114, 32323215, 32323381, 32324152, 32338057, 32346427, 32348432, 32349978, 32372618, 32373553, 32374787, 32384622 , 32385063  )
