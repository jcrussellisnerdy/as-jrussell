...
SELECT  L.NUMBER_TX , RC.TYPE_CD , C.LENDER_COLLATERAL_CODE_TX,
...
FROM    LOAN L
		...
		LEFT JOIN dbo.LENDER_ORGANIZATION LO ON LO.LENDER_ID = LL.ID 
										...
										WHERE LL.CODE_TX = '7516' AND L.RECORD_TYPE_CD = 'G' AND L.STATUS_CD = 'A'
										AND C.LENDER_COLLATERAL_CODE_TX = 'UCC'