...
SELECT * --INTO UniTracHDStorage..INC0219774
...
SET     STATUS_CD = 'Complete' ,
        UPDATE_USER_TX = 'INC0219774',
		 LOCK_ID = CASE WHEN LOCK_ID >= 255 THEN 1
                  ELSE LOCK_ID + 1 END
WHERE   ID IN  (SELECT ID FROM UniTracHDStorage..INC0219774)
...
SELECT * INTO UniTracHDStorage..LOAN_INC0219774
...
FROM    WORK_ITEM WI
	...
	SELECT	 CONTENT_XML.value('(/Content/Collateral/Type)[1]', 'varchar (50)'), * FROM UniTracHDStorage..INC0219774
	WHERE CONTENT_XML.value('(/Content/Collateral/Type)[1]', 'varchar (50)')= 'RE'
...
--                WHERE   UPDATE_USER_TX = 'INC0219774' AND CODE_TX = '3585')



--SELECT CONTENT_XML.value('(/Content/Lender/Code)[1]', 'varchar (50)'),  * FROM dbo.WORK_ITEM
--		WHERE WORKFLOW_DEFINITION_ID = '8' AND STATUS_CD = 'WITHDRAWN' AND  UPDATE_USER_TX = 'INC0219774'
--		ORDER BY RELATE_ID ASC

--		SELECT * FROM dbo.LOAN
--		WHERE UPDATE_USER_TX = 'INC0219774' 
--		ORDER BY ID ASC
