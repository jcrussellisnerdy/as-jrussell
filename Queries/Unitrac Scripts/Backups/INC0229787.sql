...
--INTO UniTracHDStorage..INC0229787
FROM    UniTrac..WORK_ITEM
WHERE    CONTENT_XML.value('(/Content/Lender/Code)[1]', 'varchar (50)') = '2177' 
...
WHERE   LENDER.CODE_TX = '2177'
		...
		AND WI.ID IN (SELECT ID FROM UniTracHDStorage..INC0229787)
		
SELECT * FROM #TMPWI

SELECT * INTO UniTracHDStorage..LOAN_INC0229787
