...
SELECT  *
INTO UniTracHDStorage..INC0278309
FROM    UniTrac..WORK_ITEM
WHERE   ID IN (36256911  )
...
--        LOCK_ID = LOCK_ID + 1 ,
--        UPDATE_DT = GETDATE() ,
--        UPDATE_USER_TX = 'INC0278309'
--WHERE   ID IN ( SELECT ID FROM UniTracHDStorage..INC0278309 )
...
SET     STATUS_CD = 'Complete' ,
        ...
        UPDATE_DT = GETDATE() ,
        UPDATE_USER_TX = 'INC0278309'
WHERE   ID IN ( SELECT ID FROM UniTracHDStorage..INC0276370 )
