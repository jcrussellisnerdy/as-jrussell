...
WHERE CONTENT_XML.value('(/Content/Lender/Code)[1]', 'varchar (50)') = '6262'
...
SELECT *INTO UniTracHDStorage..INC0206953 FROM UniTrac..WORK_ITEM
WHERE CONTENT_XML.value('(/Content/Lender/Code)[1]', 'varchar (50)') = '6262'
AND WORKFLOW_DEFINITION_ID IN (3,6,8)
--AND STATUS_CD = 'Initial'
AND WORK_ITEM.STATUS_CD NOT LIKE 'Complete' AND WORK_ITEM.STATUS_CD NOT LIKE 'Withdrawn'
...
UPDATE  UniTrac..WORK_ITEM
SET     STATUS_CD = 'Complete' ,
        UPDATE_USER_TX = 'INC0206953'
WHERE   ID IN ( 27041941)
