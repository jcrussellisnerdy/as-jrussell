...
SELECT  *
--INTO UniTracHDStorage..INC0247105 
FROM    UniTrac..WORK_ITEM
WHERE   ID  IN (33568384 , 33566183 )

SELECT * FROM dbo.WORK_ITEM_ACTION
WHERE WORK_ITEM_ID IN (33442336 , 33553487 )
ORDER BY WORK_ITEM_ID ASC

SELECT * FROM dbo.WORK_ITEM
WHERE RELATE_ID IN (
SELECT DISTINCT RELATE_ID FROM dbo.PROCESS_LOG_ITEM
WHERE PROCESS_LOG_ID IN (36990732,36990731) 
...
VALUES  ( 33568384 , -- WORK_ITEM_ID - bigint
          ...
          N'INC0247105 ' , -- UPDATE_USER_TX - nvarchar(15)
          1 , -- LOCK_ID - tinyint
...
UPDATE  UniTrac..WORK_ITEM
SET     STATUS_CD = 'Initial', 
LAST_WORK_ITEM_ACTION_ID = (SELECT MAX(ID) FROM dbo.WORK_ITEM_ACTION WHERE   WORK_ITEM_ID IN ( 33568384 )),
UPDATE_DT = GETDATE(),LOCK_ID = LOCK_ID+1, UPDATE_USER_TX = 'INC0247105'
WHERE   ID IN ( 33568384 )
        AND ACTIVE_IN = 'Y'
...
VALUES  ( 33566183  , -- WORK_ITEM_ID - bigint
         N'Initial' , -- ACTION_CD - nvarchar(30)
          N'Error' , -- FROM_STATUS_CD - nvarchar(20)
          N'Initial' , -- TO_STATUS_CD - nvarchar(20)
          5 , -- CURRENT_QUEUE_ID - bigint
...
UPDATE  UniTrac..WORK_ITEM
SET     STATUS_CD = 'Initial', 
LAST_WORK_ITEM_ACTION_ID = (SELECT MAX(ID) FROM dbo.WORK_ITEM_ACTION WHERE   WORK_ITEM_ID IN ( 33566183  )),
UPDATE_DT = GETDATE(),LOCK_ID = LOCK_ID+1, UPDATE_USER_TX = 'INC0247105'
WHERE   ID IN ( 33566183 )
