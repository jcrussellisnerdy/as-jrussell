...
SELECT CONTENT_XML.value('(/Content/Lender/Code)[1]', 'varchar (50)') Lender, * --INTO UniTracHDStorage..WI_INCXXXXX
FROM    UniTrac..WORK_ITEM
WHERE   ID IN ( SELECT ID FROM UniTracHDStorage..WI_INC0224250 )


SELECT * FROM UniTracHDStorage..WI_INC0224250
...
WHERE   LENDER.CODE_TX IN ('6607', '2247', '2405')
		...
		AND WI.ID IN ( SELECT ID FROM UniTracHDStorage..WI_INC0224250 )
		
SELECT * FROM #TMPWI

SELECT * INTO UniTracHDStorage..LOAN_INC0224250
