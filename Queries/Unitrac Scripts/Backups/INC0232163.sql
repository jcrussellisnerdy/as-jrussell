...
/*
SELECT  CONTENT_XML.value('(/Content/Lender/Code)[1]', 'varchar (50)') Lender, * --INTO UniTracHDStorage..WI_INC0232163
FROM    UniTrac..WORK_ITEM
WHERE   ID IN ( 30189924 , 30669069  )

SELECT * INTO  UniTracHDStorage..LOAN_INC0232163
FROM dbo.LOAN WHERE ID IN (SELECT relate_id FROM UniTracHDStorage..WI_INC0232163 )*/
...
WHERE   LENDER.CODE_TX = '2530'
		...
		AND WI.ID IN (30189924)
		
UPDATE  LN
SET     SPECIAL_HANDLING_XML = NULL ,
        UPDATE_DT = GETDATE() ,
        UPDATE_USER_TX = 'INC0232163' ,
