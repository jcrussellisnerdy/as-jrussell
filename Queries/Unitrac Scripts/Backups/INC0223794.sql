...
WHERE   WORKFLOW_DEFINITION_ID = 11
        ...
        AND ID IN ( 29543104 ,29648048  )
--AND CONTENT_XML.value('(/Content/Lender/Code)[1]' , 'varchar(10)') = '2771'
-----

SELECT * INTO UniTracHDStorage..INC0223794WI
 FROM  #TMPWI


 SELECT * INTO UniTracHDStorage..INC0223794WIPLIR
 FROM dbo.WORK_ITEM_PROCESS_LOG_ITEM_RELATE
 WHERE WORK_ITEM_ID = '29648048'
...
SELECT DISTINCT WORK_ITEM_ID, USER_ACTION FROM #TMP_ESCROW
WHERE USER_ACTION = ''
