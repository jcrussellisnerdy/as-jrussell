...
SELECT * 
INTO UniTracHDStorage..INC0229484
FROM UniTrac..WORK_ITEM
WHERE ID IN (30667650 ,
30667664 ,
30667666 ,
30667684 ,
30667686 )
...
VALUES  ( 30667686, -- WORK_ITEM_ID - bigint
          ...
          N'INC0229484' , -- UPDATE_USER_TX - nvarchar(15)
          1 , -- LOCK_ID - tinyint
...
WHERE WORK_ITEM_ID IN (30667650 ,
30667664 ,
30667666 ,
30667684 ,
30667686 ) AND UPDATE_USER_TX = 'INC0229484'