...
INTO #TMPLOAN
FROM LOAN L
WHERE L.ID IN (SELECT ID FROM UniTracHDStorage.dbo.LOAN_2065_2)
----- 43123
...
UPDATE_DT = GETDATE() , UPDATE_USER_TX = 'INC0332693', 
...
SELECT DISTINCT COLL.COLLATERAL_CODE_ID
...
---- SELECT COLL.COLLATERAL_CODE_ID, *
FROM COLLATERAL COLL JOIN #TMPRC_01 T1 ON T1.COLL_ID = COLL.ID
AND COLL.PURGE_DT IS NULL
