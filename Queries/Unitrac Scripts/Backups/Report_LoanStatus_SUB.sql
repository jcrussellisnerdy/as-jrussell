...
/****** Object:  StoredProcedure [dbo].[Report_LoanStatus]    Script Date: 2/19/2016 8:10:54 AM ******/
...
(
	...
	@ReportDomainName as nvarchar(50)=NULL,
...
BEGIN
	...
	/* set @Debug (make sure reset to 0 before deploying to Prod): */
	Select @Debug=0
	...
	Begin
		...
		,@LenderCode='3585'
		,@Division='3'
		,@Branch='1',@Coverage='1',@GroupByCode='',@SortByCode='',@SpecificReport='0000',@ReportDomainName='Report_LoanStatus',@Report_History_ID=''
	End
...
End
	...
	Begin
		...
		,tt.OWNER_LASTNAME_TX
		,tt.OWNER_FIRSTNAME_TX
		,COLLATERAL_VIN_TX, COLLATERAL_MORTGAGE_TX
		,LOAN_NUMBER_TX
	End
