...
SELECT CONTENT_XML.value('(/Content/Lender/Code)[1]', 'varchar (50)') Lender, * INTO UniTracHDStorage..WI_INC0233124
FROM    UniTrac..WORK_ITEM
WHERE   ID IN ( 30371526   )
...
WHERE   LENDER.CODE_TX = '6152'
		...
		AND WI.ID IN (30371526)
		
SELECT * FROM #TMPWI

SELECT * --INTO UniTracHDStorage..LOAN_INC0233124
