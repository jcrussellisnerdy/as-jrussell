...
----REPLACE INC0228429 WITH THE TICKET ID
---Checking UTLs WIs
USE UniTrac
...
SELECT * --INTO UniTracHDStorage..INC0228429
FROM UniTrac..WORK_ITEM
WHERE CONTENT_XML.value('(/Content/Lender/Code)[1]', 'varchar (50)') = '6487'
...
SELECT * INTO UniTracHDStorage..LOAN_INC0228429
