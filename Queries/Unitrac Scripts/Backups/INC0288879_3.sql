USE [UniTrac]
GO
/****** Object:  StoredProcedure [dbo].[Report_Escrow]    Script Date: 3/20/2017 1:28:55 PM ******/
SET ANSI_NULLS ON
GO
...
SET @Division = '4'
--SET @FilterByCode = ''
SET @GroupByCode = 'L/B/C/C'
SET @ReportType = 'ESCPRMDUE'
SET @SortByCode = 'BorrowerName'
...
SET @WorkItemID = '38061919'
SET @BeginDate = '2017-03-16 '
SET @EndDate = '2017-03-17 '
...
BEGIN
	...
	FROM WORK_ITEM_PROCESS_LOG_ITEM_RELATE WIPLIR 
		Join PROCESS_LOG_ITEM PLI ON WIPLIR.PROCESS_LOG_ITEM_ID = PLI.ID and PLI.RELATE_TYPE_CD = 'Allied.UniTrac.Escrow' and PLI.Purge_DT IS NULL
		Join ESCROW E on PLI.RELATE_ID = E.ID AND E.PURGE_DT IS NULL AND E.REPORTED_DT IS NOT NULL
	WHERE WIPLIR.WORK_ITEM_ID = '38061919' AND WIPLIR.PURGE_DT IS NULL 
	AND (E.REPORTED_DT BETWEEN @BeginDate and @EndDate)
...
where 
L.RECORD_TYPE_CD = @RecordTypeCode and P.RECORD_TYPE_CD = @RecordTypeCode and RC.RECORD_TYPE_CD = @RecordTypeCode and E.RECORD_TYPE_CD = 'G'
...
----SELECT * FROM  JCs..INC0288879


--DROP TABLE JCs..INC0288879