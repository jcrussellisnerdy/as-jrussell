...
--XXXXXXX in all places is the WORK_ITEM_ID
...
VALUES  ( 45736494 , -- WORK_ITEM_ID - bigint
         ...
         1 , -- CURRENT_QUEUE_ID - bigint
          ...
          N'per user Jennifer Mitchell' , -- ACTION_NOTE_TX - nvarchar(1000)
          'Y' , -- ACTIVE_IN - char(1)
          GETDATE() , -- CREATE_DT - datetime
         NULL , -- PURGE_DT - datetime
          GETDATE() , -- UPDATE_DT - datetime
          N'INC0349193' , -- UPDATE_USER_TX - nvarchar(15)
          1 , -- LOCK_ID - tinyint
...
LAST_WORK_ITEM_ACTION_ID = (SELECT MAX(ID) FROM dbo.WORK_ITEM_ACTION WHERE   WORK_ITEM_ID IN ( 45736494 )),
UPDATE_DT = GETDATE(),LOCK_ID = LOCK_ID+1, UPDATE_USER_TX = 'INC0349193'
--SELECT * FROM dbo.WORK_ITEM
WHERE   ID IN ( 45736494 )
