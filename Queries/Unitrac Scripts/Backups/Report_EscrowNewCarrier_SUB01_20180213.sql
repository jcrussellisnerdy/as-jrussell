...
/****** Object:  StoredProcedure [dbo].[Report_EscrowNewCarrier]    Script Date: 2/13/2018 10:52:29 AM ******/
SET ANSI_NULLS ON
GO
 ...
 */
 CROSS Apply(
 Select Top 1
  ESP.ID, ESP.EFFECTIVE_DT, ESP.END_DT, ESP.DUE_DT, ESP.TOTAL_AMOUNT_NO, ESP.BIC_ID, ESP.REMITTANCE_ADDR_ID, ESP.POLICY_NUMBER_TX
