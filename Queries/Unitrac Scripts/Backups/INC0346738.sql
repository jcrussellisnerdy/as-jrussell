...
----Backup WI
SELECT  *
INTO UniTracHDStorage..INC0346738
FROM    UniTrac..WORK_ITEM
WHERE   ID IN (45194397  )
...
/*
update N
set template_id = '12', lock_id = lock_id+1, update_dt = getdate(), update_user_tx = 'INC0346738', PDF_GENERATE_CD ='PEND'
--select *
 from notice N
WHERE ID IN (SELECT * FROM #tmpN) AND PDF_GENERATE_CD IN ('NT' , 'ERR')
