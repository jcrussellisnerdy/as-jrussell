...
/****** Object:  StoredProcedure [dbo].[Report_LoanStatus]    Script Date: 7/13/2016 7:26:01 PM ******/
SET ANSI_NULLS ON
GO
...
*/
	...
	cross apply(
		select WithLoans = stuff(
			(select ', '
			 + l.number_tx
			 + case when c.STATUS_CD = 'A' then '' when c.STATUS_CD = 'U' then '(UTL)' else '(' + c.status_cd + ')' end
