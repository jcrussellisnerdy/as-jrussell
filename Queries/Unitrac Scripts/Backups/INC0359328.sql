---- DROP TABLE #TMPINC0359328
SELECT * 
INTO #TMPINC0359328
FROM UTSTAGE01.UNITRAC.DBO.TMPINC0359328
---- 193
...
INTO #TMPLOAN
FROM LOAN 
WHERE LOAN.NUMBER_TX IN (		'5523400000',
	'8223800000' ,
		'8282600000'
) and lender_id = 2065
----- 43123
...
UPDATE_DT = GETDATE() , UPDATE_USER_TX = 'INC0359328', 
...
--AND COLL.PURGE_DT IS NULL
--JOIN #TMPINC0359328 T2 ON T2.NEWNUMBER = T1.NUMBER_TX
...
update rc
	set UPDATE_DT = GETDATE() ,
		...
		---- SELECT RC.RECORD_TYPE_CD , RC.CPI_QUOTE_ID , RC.NOTICE_SEQ_NO ,  t.*
	from #TMPRC_01 t    
