...
SELECT  CONTENT_XML.value('(/Content/Lender/Code)[1]', 'varchar (50)'), * --INTO UniTracHDStorage..INC0211030
FROM    UniTrac..WORK_ITEM
WHERE   ID IN ( 26811975 , 27083190  )
