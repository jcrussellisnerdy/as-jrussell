...
SELECT * INTO UniTracHDStorage..LOAN_INC0252628
FROM dbo.LOAN WHERE ID IN (SELECT LOAN_ID FROM #TMPWI)

SELECT * INTO UniTracHDStorage..WI_INC0252628
...
SELECT * FROM  UniTracHDStorage..WI_INC0252628

SELECT * FROM UniTracHDStorage..LOAN_INC0252628
