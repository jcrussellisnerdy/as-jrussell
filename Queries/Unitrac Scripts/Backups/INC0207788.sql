...
SELECT * INTO UniTracHDStorage..INC0207788
FROM dbo.WORK_ITEM
WHERE ID IN (26367656, 26367674, 26389470)
...
SELECT * FROM UniTracHDStorage..INC0207788
...
WHERE   LENDER.CODE_TX = '6350'
		...
		AND WI.ID IN (SELECT ID FROM UniTracHDStorage..INC0207788)
