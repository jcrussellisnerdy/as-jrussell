...
SELECT CONTENT_XML.value('(/Content/Lender/Code)[1]', 'varchar (50)') Lender, * INTO UniTracHDStorage..WI_INC0241342
FROM    UniTrac..WORK_ITEM
WHERE   WORKFLOW_DEFINITION_ID = '8' and RELATE_ID IN (150735907,
157336804)
...
WHERE   LENDER.CODE_TX = '8600'
		...
		AND WI.ID IN (SELECT ID FROM UniTracHDStorage..WI_INC0241342)
		
SELECT * FROM #TMPWI

SELECT * INTO UniTracHDStorage..LOAN_INC0241342
