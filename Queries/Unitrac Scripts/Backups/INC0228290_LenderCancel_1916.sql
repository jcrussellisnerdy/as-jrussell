...
----REPLACE INC0228290 WITH THE TICKET ID
---Checking UTLs WIs
USE UniTrac
...
SELECT * --INTO UniTracHDStorage..INC0228290
 FROM UniTrac..WORK_ITEM
WHERE CONTENT_XML.value('(/Content/Lender/Code)[1]', 'varchar (50)') = '1916'
...
SET     STATUS_CD = 'Complete' ,
        UPDATE_USER_TX = 'INC0228290',
		 LOCK_ID = CASE WHEN LOCK_ID >= 255 THEN 1
                  ELSE LOCK_ID + 1 END
WHERE   ID IN  ( SELECT ID FROM UniTracHDStorage..INC0228290 )
...
SELECT * --INTO UniTracHDStorage..LOAN_INC0228290
FROM dbo.LOAN WHERE ID IN (7275934,
135079699,
89867370)
...
UPDATE_DT = GETDATE() , UPDATE_USER_TX = 'INC0228290' , 
...
CURRENT_OWNER_ID , 'INC0228290' , 'Y' , GETDATE() , GETDATE() , 'INC0228290' , 1 , 1
FROM #TMPWII
ORDER BY STATUS_CD
---- 
