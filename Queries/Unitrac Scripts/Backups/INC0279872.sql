...
SELECT  *
--INTO UniTracHDStorage..INC0279872
FROM    UniTrac..WORK_ITEM
WHERE   ID IN (36666254 )
...
--        LOCK_ID = LOCK_ID + 1 ,
--        UPDATE_DT = GETDATE() ,
--        UPDATE_USER_TX = 'INC0279872'
--WHERE   ID IN ( SELECT ID FROM UniTracHDStorage..INC0279872 )
