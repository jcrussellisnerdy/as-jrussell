...
----REPLACE INC0281531 WITH THE TICKET ID
---Checking UTLs WIs
USE UniTrac

--SELECT * FROM dbo.LENDER WHERE CODE_TX IN ('4846')
...
SET     STATUS_CD = 'Complete' ,
        UPDATE_USER_TX = 'INC0281531',
		 LOCK_ID = CASE WHEN LOCK_ID >= 255 THEN 1
                  ELSE LOCK_ID + 1 END
WHERE   ID IN  (  SELECT ID FROM UniTracHDStorage..INC0281531)
...
SELECT * INTO UniTracHDStorage..LOAN_INC0281531
