...
/****** Object:  UserDefinedFunction [dbo].[fn_GetCPICancelActivityTerms]    Script Date: 8/11/2017 3:25:02 PM ******/
SET ANSI_NULLS ON
GO
      ...
      begin
         ...
         begin  
            ...
            begin
               ...
               insert into @OUTPUT
               select   @FPC_ID, @splitTermCounter, charges - payments, PERIOD_START_DT, PERIOD_END_DT
