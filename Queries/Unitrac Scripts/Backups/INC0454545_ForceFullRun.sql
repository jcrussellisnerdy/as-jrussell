...
select 'Allied.UniTrac.ProcessHelper.UniTracProcessDefinition', '82796', 'Force to run to get full cycle', 'INC0454545', 'INC0454545', 'N', GEtDATE(),'1', 'Force to run to get full cycle', 'Y', 'Y','1','Osprey.ProcessMgr.ProcessDefinition', NULL, 'NEW', GETDATE()
