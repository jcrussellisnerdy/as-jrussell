...
DECLARE @NextFullCycleDate nvarchar(25) = '10/5/2019 12:15:00 AM'  --remember to ensure that it is in the central time zone 
...
DECLARE @LastFullCycleDate nvarchar(25) = '9/21/2019 3:01:12 AM'  --remember to ensure that it is in the central time zone 
...
DECLARE @newNextAnticipated nvarchar(25) = '9/25/2019 12:15:00 AM'  --remember to ensure that it is in the central time zone 
...
select 'Allied.UniTrac.ProcessHelper.UniTracProcessDefinition', '18335', 'Setting per user standards', 'INC0455298', 'INC0455298', 'N', GEtDATE(),'1', 'Setting per user standards', 'Y', 'Y','1','Osprey.ProcessMgr.ProcessDefinition', NULL, 'NEW', GETDATE()
