...
SELECT CONTENT_XML.value('(/Content/Lender/Code)[1]', 'varchar (50)') Lender, * --INTO UniTracHDStorage..WI_INC0228704
FROM    UniTrac..WORK_ITEM
WHERE   ID IN ( 27568973  )
...
WHERE   LENDER.CODE_TX = '3525'
		...
		AND WI.ID IN (27568973)
		
SELECT * FROM #TMPWI

SELECT * INTO UniTracHDStorage..LOAN_INC0228704
