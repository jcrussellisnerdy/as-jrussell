...
SELECT L.NUMBER_TX, p.*
 --into unitrachdstorage..INC0380141
 FROM LOAN L
INNER JOIN COLLATERAL C ON L.ID = C.LOAN_ID
INNER JOIN PROPERTY P ON C.PROPERTY_ID = P.ID
WHERE P.LENDER_ID =78 --AND L.NUMBER_TX IN ('164026-46')
and YEAR_TX = '0' and L.DIVISION_CODE_TX = '4'

update p 
set year_tx = NULL, update_dt = GETDATE(), update_user_tx = 'INC0380141',lock_id = lock_id+1
--select year_tx, *
from property P
where id in (select id from unitrachdstorage..INC0380141)
...
WHERE L.CODE_TX = '1936' AND Lo.TYPE_CD = 'DIV'
