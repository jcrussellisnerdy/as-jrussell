...
WHERE   WI.ID IN (  46743935,45807652 ,44607552) 
...
SELECT * INTO UniTracHDStorage..LOAN_INC0357543
FROM dbo.LOAN WHERE ID IN (SELECT LOAN_ID FROM #TMPWI)

SELECT * INTO UniTracHDStorage..WI_INC0357543
