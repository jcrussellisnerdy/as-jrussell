...
WHERE   WI.ID IN ( 35908731,35955006   )
...
SELECT * INTO UniTracHDStorage..LOAN_INC0277699
FROM dbo.LOAN WHERE ID IN (SELECT LOAN_ID FROM #TMPWI)

SELECT * INTO UniTracHDStorage..WI_INC0277699
