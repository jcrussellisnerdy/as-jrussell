...
SELECT * 
INTO UniTracHDStorage..INC0277630
FROM UniTrac..WORK_ITEM
WHERE ID IN (35903982)
...
VALUES  ( 35903982  , -- WORK_ITEM_ID - bigint
          ...
          N'INC0277630' , -- UPDATE_USER_TX - nvarchar(15)
          1 , -- LOCK_ID - tinyint
...
LAST_WORK_ITEM_ACTION_ID = (SELECT MAX(ID) FROM dbo.WORK_ITEM_ACTION WHERE   WORK_ITEM_ID IN ( 35903982  )),
UPDATE_DT = GETDATE(),LOCK_ID = LOCK_ID+1, UPDATE_USER_TX = 'INC0277630'
WHERE   ID IN (SELECT ID FROM UniTracHDStorage..INC0277630)
