...
SELECT  CONTENT_XML.value('(/Content/Lender/Code)[1]', 'varchar (50)'),* FROM UniTrac..WORK_ITEM
WHERE CONTENT_XML.value('(/Content/Lender/Code)[1]', 'varchar (50)') = '7559'
...
UPDATE  UniTrac..WORK_ITEM
SET     STATUS_CD = 'Complete' ,
        UPDATE_USER_TX = 'INC0204055'
WHERE   ID IN (26331703,
26541825,
26130192,
26355037,
26331702,
...
SELECT CONTENT_XML.value('(/Content/Lender/Code)[1]', 'varchar (50)'),  * FROM dbo.WORK_ITEM
		WHERE WORKFLOW_DEFINITION_ID = '8'  AND ID IN (4678496, 4348676) 
		--AND   UPDATE_USER_TX = 'INC0204055'
...
WHERE CODE_TX = '7559'
		...
		UPDATE dbo.LOAN
		SET UPDATE_USER_TX = 'INC0204055'
		WHERE UPDATE_USER_TX = 'INC0######' AND UPDATE_DT = '2015-09-21 10:54:18.400'
