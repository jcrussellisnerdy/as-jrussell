...
----REPLACE INC0229396 WITH THE TICKET ID
---Checking UTLs WIs
USE UniTrac

SELECT  * 
--INTO UniTracHDStorage..INC0229396
FROM    WORK_ITEM
...
WHERE CONTENT_XML.value('(/Content/Lender/Code)[1]', 'varchar (50)') = '844443'
...
SET     STATUS_CD = 'Complete' ,
        UPDATE_USER_TX = 'INC0229396',
		 LOCK_ID = CASE WHEN LOCK_ID >= 255 THEN 1
                  ELSE LOCK_ID + 1 END
WHERE   ID IN  (SELECT ID FROM UniTracHDStorage..INC0229396)
...
SELECT * INTO UniTracHDStorage..LOAN_INC0229396
...
INTO    #TMPWI
FROM    UniTrac..WORK_ITEM
WHERE   ID IN ( 27984027  )



UPDATE WI SET STATUS_CD = 'Withdrawn' , 
UPDATE_DT = GETDATE() , UPDATE_USER_TX = 'INC0229396' , 
...
CURRENT_OWNER_ID , 'INC0229396' , 'Y' , GETDATE() , GETDATE() , 'INC0229396' , 1 , 1
FROM #TMPWI
ORDER BY STATUS_CD
---- 
