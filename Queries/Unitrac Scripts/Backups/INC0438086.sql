...
DECLARE @NextFullCycleDate nvarchar(25) = '8/1/2019 12:10:00 AM'  --remember to ensure that it is in the central time zone 
DECLARE @Task nvarchar(15) = 'INC0438086'
...
DECLARE @LastFullCycleDate nvarchar(25) = '7/18/2019 5:29:33 AM'  --remember to ensure that it is in the central time zone 
