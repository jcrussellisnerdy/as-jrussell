...
----REPLACE 7620 WITH THE THE Lender ID
----REPLACE INC0234884 WITH THE TICKET ID
---Checking UTLs WIs
USE UniTrac

SELECT  * 
--INTO UniTracHDStorage..INC0234884
FROM    WORK_ITEM
...
SELECT CONTENT_XML.value('(/Content/Collateral/Type)[1]', 'varchar (50)') [Collateral], * 
INTO UniTracHDStorage..INC0234884
FROM UniTrac..WORK_ITEM
WHERE CONTENT_XML.value('(/Content/Lender/Code)[1]', 'varchar (50)') = '7620'
...
SET     STATUS_CD = 'Complete' ,
        UPDATE_USER_TX = 'INC0234884',
		 LOCK_ID = CASE WHEN LOCK_ID >= 255 THEN 1
                  ELSE LOCK_ID + 1 END
WHERE   ID IN  ( SELECT ID FROM UniTracHDStorage..INC0234884)
...
SELECT * INTO UniTracHDStorage..LOAN_INC0234884
