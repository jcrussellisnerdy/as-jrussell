...
Begin
	Select top 65000 *
	into jcs..INC0286265_section_1_Lender5044
	From #tmptable
	order by LOAN_BALANCE_DT, OWNER_LASTNAME_TX ASC


		Select top 65000 *
	into jcs..INC0286265_section_2_Lender5044
	From #tmptable
	where LOAN_ID not in (select LOAN_ID from jcs..INC0286265_section_1_Lender5044)
		order by LOAN_BALANCE_DT, OWNER_LASTNAME_TX ASC


	
		Select top 65000 *
	into jcs..INC0286265_section_3_Lender5044
	From #tmptable
	where (LOAN_ID not in (select LOAN_ID from jcs..INC0286265_section_1_Lender5044) and LOAN_ID not in (select LOAN_ID from jcs..INC0286265_section_2_Lender5044))
	order by LOAN_ID ASC


		Select top 65000 *
	into jcs..INC0286265_section_4_Lender5044
	From #tmptable
	where (LOAN_ID not in (select LOAN_ID from jcs..INC0286265_section_1_Lender5044) and LOAN_ID not in (select LOAN_ID from jcs..INC0286265_section_2_Lender5044) and LOAN_ID not in (select LOAN_ID from jcs..INC0286265_section_3_Lender5044))
	order by LOAN_ID ASC

		
		Select top 65000 *
	into jcs..INC0286265_section_5_Lender5044
	From #tmptable
	where (LOAN_ID not in (select LOAN_ID from jcs..INC0286265_section_1_Lender5044) and LOAN_ID not in (select LOAN_ID from jcs..INC0286265_section_2_Lender5044) and LOAN_ID not in (select LOAN_ID from jcs..INC0286265_section_3_Lender5044) and LOAN_ID not in (select LOAN_ID from jcs..INC0286265_section_4_Lender5044))
	order by LOAN_ID ASC


		Select top 65000 *
	into jcs..INC0286265_section_6_Lender5044
	From #tmptable
	where (LOAN_ID not in (select LOAN_ID from jcs..INC0286265_section_1_Lender5044) and LOAN_ID not in (select LOAN_ID from jcs..INC0286265_section_2_Lender5044) and LOAN_ID not in (select LOAN_ID from jcs..INC0286265_section_3_Lender5044) and  LOAN_ID not in (select LOAN_ID from jcs..INC0286265_section_4_Lender5044) and LOAN_ID not in (select LOAN_ID from jcs..INC0286265_section_5_Lender5044))
	order by LOAN_ID ASC
