...
SELECT  *
--INTO UniTracHDStorage..INC0273455
FROM    UniTrac..WORK_ITEM
WHERE   ID IN (35312585, 35378800, 35378802, 35298685)
...
SET     STATUS_CD = 'Initial' ,
        LOCK_ID = LOCK_ID + 1 ,
        UPDATE_DT = GETDATE() ,
        UPDATE_USER_TX = 'INC0273455'
WHERE   ID IN ( SELECT ID FROM UniTracHDStorage..INC0273455 )
        AND WORKFLOW_DEFINITION_ID = 9
        AND ACTIVE_IN = 'Y'
