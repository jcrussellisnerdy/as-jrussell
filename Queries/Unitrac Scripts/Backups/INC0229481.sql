...
SELECT CONTENT_XML.value('(/Content/Lender/Code)[1]', 'varchar (50)') Lender, * INTO UniTracHDStorage..WI_INC0229481
FROM    UniTrac..WORK_ITEM
WHERE   ID IN ( 30333476  )
