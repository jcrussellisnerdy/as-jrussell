...
WHERE ID IN (27319109 )

SELECT * INTO UniTracHDStorage..INC0207626
FROM dbo.WORK_ITEM
WHERE ID IN (27319109 )

SELECT ID, * FROM UniTracHDStorage..INC0207626


SELECT * FROM dbo.WORK_ITEM_ACTION
WHERE WORK_ITEM_ID IN (SELECT ID FROM UniTracHDStorage..INC0207626)
...
WHERE   ID IN (SELECT ID FROM UniTracHDStorage..INC0207626 )
...
VALUES  ( 27319109 , -- WORK_ITEM_ID - bigint
