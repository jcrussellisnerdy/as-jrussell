...
DECLARE @NextFullCycleDate nvarchar(25) = '7/14/2019 12:30:00 AM' --remember to ensure that it is in the central time zone 
DECLARE @Task nvarchar(15) = 'INC0433143'
...
DECLARE @LastFullCycleDate nvarchar(25) =  '6/30/2019 2:17:43 AM'  --remember to ensure that it is in the central time zone 
