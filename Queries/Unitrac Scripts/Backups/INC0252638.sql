...
SELECT T.ID [WI_ID],  WIPLI.ID [WIPLI_ID], WIPLI.PURGE_DT [WIPLI.PURGE_DT], PLI.ID [PLI_ID], PLI.PURGE_DT [PLI.PURGE_DT], PLI.RELATE_TYPE_CD,
...
UPDATE WIPLI
SET WIPLI.PURGE_DT = T.[WIPLI.PURGE_DT]
--SELECT *
FROM dbo.WORK_ITEM_PROCESS_LOG_ITEM_RELATE WIPLI
JOIN  #TMP T ON T.[WIPLI_ID] = WIPLI.ID
