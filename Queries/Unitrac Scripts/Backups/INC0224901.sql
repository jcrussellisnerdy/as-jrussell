...
WHERE LL.CODE_TX IN ('5350') AND (OP.BIC_NAME_TX  IN ('Affirmative Insurance Company', 'AIC', 'Affirmative') or OP.BIC_NAME_TX  LIKE 'Affirmative%' OR OP.BIC_NAME_TX  LIKE '%AIC%' OR OP.BIC_NAME_TX  LIKE 'AFF%')
