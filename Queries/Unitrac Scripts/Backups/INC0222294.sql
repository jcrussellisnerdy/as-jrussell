...
-- Required Coverage table of all the new loans that the business wanted updated to audit
SELECT * FROM UniTracHDStorage..INC0222294_RC_ONLYNew


-- All from the loan status info status and loan
SELECT * FROM UniTracHDStorage..INC0222294