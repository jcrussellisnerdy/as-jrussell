...
WHERE   WI.ID IN ( 33575794,34170359,34186101,34759797,35066857   )
...
SELECT * INTO UniTracHDStorage..LOAN_INC0272011
FROM dbo.LOAN WHERE ID IN (SELECT LOAN_ID FROM #TMPWI)

SELECT * INTO UniTracHDStorage..WI_INC0272011
