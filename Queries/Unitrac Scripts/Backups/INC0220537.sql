...
SELECT * --INTO UniTracHDStorage..INC0220537
FROM UniTrac..WORK_ITEM
WHERE CONTENT_XML.value('(/Content/Lender/Code)[1]', 'varchar (50)') = '7542'
...
SET     STATUS_CD = 'Complete' ,
        UPDATE_USER_TX = 'INC0220537',
		 LOCK_ID = CASE WHEN LOCK_ID >= 255 THEN 1
                  ELSE LOCK_ID + 1 END
WHERE   ID IN  ( SELECT ID FROM UniTracHDStorage..INC0220537 )
...
SELECT * INTO UniTracHDStorage..LOAN_INC0220537
...
--                WHERE   UPDATE_USER_TX = 'INC0######' AND CODE_TX = '7542')
