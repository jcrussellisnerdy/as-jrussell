...
WHERE   WI.ID IN ( 34785121, 313199030, 34816142, 35208749, 35586041, 35208678,
                   35854154, 35657886, 35658031, 36170149, 33873098, 33873116,
                   31319930 )
...
SELECT * INTO UniTracHDStorage..LOAN_INC0278071_2
FROM dbo.LOAN WHERE ID IN (SELECT LOAN_ID FROM #TMPWI)

SELECT * INTO UniTracHDStorage..WI_INC0278071_2
