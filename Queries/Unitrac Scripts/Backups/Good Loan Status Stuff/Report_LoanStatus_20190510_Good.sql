...
/****** Object:  StoredProcedure [dbo].[Report_LoanStatus]    Script Date: 5/10/2019 2:44:06 PM ******/
SET ANSI_NULLS ON
GO
...
BEGIN
/*TFS#48839:
	select @SpecificReport='ACTLNSTA_FLD'
	--,@debug=1
...
if @debug = 1
begin
	select @insert as [@insert:1796]
	select @columns as [@columns:1797]
	select @joins as [@joins:1798]
	select isnull(@conditions,'') as [@conditions:1799]
	select replace(@finalquery, @insert, '') as [@selectquery:1800]
end
