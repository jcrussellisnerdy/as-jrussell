SELECT DISTINCT L.NUMBER_TX, GOOD_THRU_DT, RC.ID, RC.SUMMARY_STATUS_CD, RC.SUMMARY_SUB_STATUS_CD, RC.INSURANCE_STATUS_CD, RC.INSURANCE_SUB_STATUS_CD
...
WHERE --CODE_CD IN ('F', 'D') AND 
 DOMAIN_CD IN ('RequiredCoverageInsSubStatus','RequiredCoverageInsStatus')
...
SELECT DISTINCT
	...
	GETDATE(),
	1,
	'Changed Summary status to Borrower Insurance In Force',
	'N',
	'Y',
	1,
	'Allied.UniTrac.RequiredCoverage',
