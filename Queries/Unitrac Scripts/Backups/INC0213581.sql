...
SELECT CONTENT_XML.value('(/Content/Lender/Code)[1]', 'varchar (50)') Lender, * --INTO UniTracHDStorage..NC0213581
FROM    UniTrac..WORK_ITEM
WHERE   ID IN ( 28172358   )
...
----REPLACE XXXXXXX WITH THE THE WI ID
UPDATE  UniTrac..WORK_ITEM
SET     STATUS_CD = 'Complete', UPDATE_USER_TX = 'INC0213581'
WHERE   ID IN ( 28172358 )
