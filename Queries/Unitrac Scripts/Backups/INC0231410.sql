...
SELECT CONTENT_XML.value('(/Content/Lender/Code)[1]', 'varchar (50)') Lender, * INTO UniTracHDStorage..WI_INC0231410
FROM    UniTrac..WORK_ITEM
WHERE   ID IN ( 27264428   )
...
WHERE   LENDER.CODE_TX = '1946'
		...
		AND WI.ID IN (27264428)
		
SELECT * FROM #TMPWI

SELECT * INTO UniTracHDStorage..LOAN_INC0231410
