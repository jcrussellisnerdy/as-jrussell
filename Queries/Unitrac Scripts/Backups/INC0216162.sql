...
SELECT CONTENT_XML.value('(/Content/Lender/Code)[1]', 'varchar (50)') Lender, * --INTO UniTracHDStorage..WI_INC0216162
FROM    UniTrac..WORK_ITEM
WHERE   ID IN ( 27123979 , 27123980  )
...
WHERE   LENDER.CODE_TX = '4500'
		...
		AND WI.ID IN (SELECT ID FROM  UniTracHDStorage..WI_INC0216162)
		
SELECT * FROM #TMPWI

SELECT * INTO UniTracHDStorage..LOAN_INC0216162
...
SELECT * FROM UniTracHDStorage..LOAN_INC0216162

SELECT * FROM UniTracHDStorage..WI_INC0216162