------------ Two Changes in Update Section (1. Work Item#, and 2. Backup Table Name)
------------ DONT GO BEYOND LINE 84, UNLESS YOU NEED TO!!!!!!!

------ Check Before Updates
SELECT  *
FROM    UniTrac..WORK_ITEM
WHERE   ID IN ( 32729882 );


SELECT * FROM dbo.WORK_ITEM_ACTION
WHERE WORK_ITEM_ID IN ( 32729882 );

-- GET THE WORK ITEM TO BE RE-OPENED
--- CHECK IF THE WI IS CLOSED AND IT RETURNS COUNT > 0
---- REPLACE 32729882X WITH THE WORK ITEM ID
...
---- replace 32729882 with WI ID
SELECT * 
INTO UnitracHDStorage.dbo.tmBug_WI_32729882
FROM #TMPWI_02
...
UPDATE_DT = GETDATE() , UPDATE_USER_TX = 'INC0241771' , 
...
FROM ESCROW ESC JOIN UnitracHDStorage.dbo.tmBug_WI_32729882 TMP
