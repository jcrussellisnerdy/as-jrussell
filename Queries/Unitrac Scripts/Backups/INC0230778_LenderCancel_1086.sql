...
----REPLACE INC0230778 WITH THE TICKET ID
---Checking UTLs WIs
USE UniTrac

SELECT  * 
--INTO UniTracHDStorage..INC0230778
FROM    WORK_ITEM
...
WHERE CONTENT_XML.value('(/Content/Lender/Code)[1]', 'varchar (50)') = '1086'
...
SELECT * INTO UniTracHDStorage..LOAN_INC0230778
