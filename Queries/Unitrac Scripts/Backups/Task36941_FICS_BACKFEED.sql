...
'<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xslHelper="urn:xslHelper" xmlns:msxsl="urn:schemas-microsoft-com:xslt" xmlns:FormatInsurance="urn:custom-scripts-csharp" version="1.0">
   ...
   <xsl:template match="Loan">
      ...
      <!-- 01: Lender # -->
      <xsl:choose>
         <xsl:when test="xslHelper:GetCompanyPayeeCd(Colls/Coll[@id=$CollID]/Cvgs/Cvg[@id=$ReqCovID]/@escrowIn, Colls/Coll[@id=$CollID]/Cvgs/Cvg[@id=$ReqCovID]/@fpcInd, Colls/Coll[@id=$CollID]/Cvgs/Cvg[@id=$ReqCovID]/Plcys/Plcy[@id=$PlcyID]/@bicID, @num, Colls/Coll[@id=$CollID]/@line1, Colls/Coll[@id=$CollID]/Cvgs/Cvg[@id=$ReqCovID]/@typ)=''        ''">
            <!--SKIP -->
         </xsl:when>
         <xsl:otherwise>
