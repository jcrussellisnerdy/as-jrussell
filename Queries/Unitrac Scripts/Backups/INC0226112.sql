...
--SELECT * INTO UniTracHDStorage..INCXXXXXX FROM #TMPWI
--
---- 
...
SELECT * FROM #TMP_ESCROW WHERE USER_ACTION = ''
  ...
  WHERE ID  IN ( 30131823  )

  SELECT * FROM dbo.WORK_ITEM_ACTION
  WHERE WORK_ITEM_ID  IN ( 30131823  )

  UPDATE WP SET PURGE_DT = PLI.PURGE_DT
 -- SELECT * 
   FROM dbo.PROCESS_LOG_ITEM WP
   INNER JOIN UniTracHDStorage..PLI1156614900_20160318 PLI ON WP.ID = PLI.ID
 

   UPDATE WP SET PURGE_DT = PLI.PURGE_DT
 -- SELECT * 
   FROM dbo.WORK_ITEM_ACTION WP
   INNER JOIN UniTracHDStorage..WI30131823_20160318 PLI ON WP.WORK_ITEM_ID = PLI.WORK_ITEM_ID



   SELECT * FROM UniTracHDStorage..PLI1156614900_20160318 

   SELECT * FROM UniTracHDStorage..WI30131823_20160318