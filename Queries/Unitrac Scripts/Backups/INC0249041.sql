...
WHERE   WORKFLOW_DEFINITION_ID = 11
        AND STATUS_CD = 'INITIAL' and 
        ID IN ( 33832398, 33878130, 33901330, 33925912, 33937505, 33950459, 33950475, 33969296 , 33988116  )
...
UPDATE dbo.PROCESS_LOG_ITEM
SET PURGE_DT = '2016-09-13 12:59:13.960'
--SELECT * FROM dbo.PROCESS_LOG_ITEM
WHERE ID IN (1361394449)

UPDATE dbo.WORK_ITEM_PROCESS_LOG_ITEM_RELATE
SET PURGE_DT = '2016-09-13 12:59:13.963'
WHERE ID = '39942477'