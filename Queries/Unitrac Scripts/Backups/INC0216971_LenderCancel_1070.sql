...
SELECT * --INTO UniTracHDStorage..INC0216971
FROM UniTrac..WORK_ITEM
WHERE CONTENT_XML.value('(/Content/Lender/Code)[1]', 'varchar (50)') = '1070'
...
SELECT * FROM UniTracHDStorage..INC0216971
-------- Clear UTLs (- rows)
UPDATE  UniTrac..WORK_ITEM
SET     STATUS_CD = 'Complete' ,
        UPDATE_USER_TX = 'INC0216971',
		 LOCK_ID = CASE WHEN LOCK_ID >= 255 THEN 1
                  ELSE LOCK_ID + 1 END
WHERE   ID IN  (SELECT ID FROM UniTracHDStorage..INC0216971)
...
SELECT * INTO UniTracHDStorage..LOAN_INC0216971_2
...
FROM    WORK_ITEM WI
		...
		SELECT * FROM UniTracHDStorage..LOAN_INC0216971_2
...
--                WHERE   UPDATE_USER_TX = 'INC0216971' AND CODE_TX = '####')



--SELECT CONTENT_XML.value('(/Content/Lender/Code)[1]', 'varchar (50)'),  * FROM dbo.WORK_ITEM
--		WHERE WORKFLOW_DEFINITION_ID = '8' AND STATUS_CD = 'WITHDRAWN' AND  UPDATE_USER_TX = 'INC0216971'
--		ORDER BY RELATE_ID ASC

--		SELECT * FROM dbo.LOAN
--		WHERE UPDATE_USER_TX = 'INC0216971' 
--		ORDER BY ID ASC
