...
SELECT  *
INTO UniTracHDStorage..INC0277089
FROM    UniTrac..WORK_ITEM
WHERE   ID IN (35878516 )
...
--        LOCK_ID = LOCK_ID + 1 ,
--        UPDATE_DT = GETDATE() ,
--        UPDATE_USER_TX = 'INC0277089'
--WHERE   ID IN ( SELECT ID FROM UniTracHDStorage..INC0277089 )
