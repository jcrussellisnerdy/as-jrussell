...
/****** Object:  StoredProcedure [dbo].[Report_ExtractReports]    Script Date: 1/28/2016 11:58:38 AM ******/
...
SELECT * INTO #T2 FROM #tmpTable CROSS APPLY dbo.fn_FilterCollateralByDivisionCd(COLLATERAL_ID, @Division) fn_FCBD WHERE
