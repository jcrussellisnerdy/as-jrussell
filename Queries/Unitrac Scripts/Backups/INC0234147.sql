...
WHERE   WORKFLOW_DEFINITION_ID = 11
        ...
        AND ID IN ( 31205941, 31349119, 31446401, 31450218, 31454338, 31475412, 31472995, 31487796, 31504285, 31505360, 31521332, 31535822 , 31552345  )
--AND CONTENT_XML.value('(/Content/Lender/Code)[1]' , 'varchar(10)') = '2771'
-----

--SELECT * INTO Unitrac. FROM #TMPWI
