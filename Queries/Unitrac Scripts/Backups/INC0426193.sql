...
declare @PDID bigint = '2129'
DECLARE @NextFullCycleDate nvarchar(25) = '06/12/2019 1:45:00 AM'  --remember to ensure that it is in the central time zone 
DECLARE @Task nvarchar(15) = 'INC0426193'
