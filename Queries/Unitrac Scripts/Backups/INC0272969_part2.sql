...
SELECT  * INTO UniTracHDStorage.dbo.LOAN_4171_2
FROM    dbo.LOAN
WHERE   LENDER_ID IN ( 2275 )
        AND NUMBER_TX IN ( '142322-02' )

SELECT * FROM UniTracHDStorage.dbo.LOAN_4171_2

UPDATE  Loan
SET     NUMBER_TX = '14232202' ,
        UPDATE_DT = GETDATE() ,
        UPDATE_USER_TX = 'INC0272969'
WHERE   NUMBER_TX = '142322-02'
        AND LENDER_ID = 2275
...
FROM LOAN
WHERE ID IN (SELECT ID FROM UnitracHDStorage.dbo.LOAN_4171_2)
--42
...
select PROPERTY_CHANGE.ID,'LOAN',ENTITY_ID,'NUMBER_TX',UnitracHDStorage.dbo.LOAN_4171_2.NUMBER_TX,LOAN.NUMBER_TX,1,'2016-11-23 00:00:00.000','Y','U'
from PROPERTY_CHANGE
INNER JOIN LOAN ON PROPERTY_CHANGE.ENTITY_ID = LOAN.ID AND ENTITY_NAME_TX = 'Allied.UniTrac.Loan' 
INNER JOIN UnitracHDStorage.dbo.LOAN_4171_2 ON LOAN.ID = UnitracHDStorage.dbo.LOAN_4171_2.ID --AND ENTITY_NAME_TX = 'Allied.UniTrac.Loan' 
WHERE PROPERTY_CHANGE.CREATE_DT = '2016-11-23 00:00:00.000'
AND ENTITY_ID IN (SELECT ID FROM UnitracHDStorage.dbo.LOAN_4171_2)
--0
...
FROM UnitracHDStorage.dbo.LOAN_4171_2 HD INNER JOIN dbo.LOAN ON HD.ID = LOAN.ID
--42
...
AND LOAN_ID in (select ID FROM UnitracHDStorage.dbo.LOAN_4171_2)
--42


EXEC SaveSearchFullText	120955660
EXEC SaveSearchFullText	122460389