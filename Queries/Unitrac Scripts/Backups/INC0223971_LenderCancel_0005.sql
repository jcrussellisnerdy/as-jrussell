...
SELECT * --INTO UniTracHDStorage..INC0223971
FROM UniTrac..WORK_ITEM
WHERE CONTENT_XML.value('(/Content/Lender/Code)[1]', 'varchar (50)') = '0005'
...
UPDATE  UniTrac..WORK_ITEM
SET     STATUS_CD = 'Complete' ,
        UPDATE_USER_TX = 'INC0223971'
WHERE   ID IN ( SELECT ID FROM UniTracHDStorage..INC0223971 )
