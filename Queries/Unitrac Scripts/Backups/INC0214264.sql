...
SELECT CONTENT_XML.value('(/Content/Lender/Code)[1]', 'varchar (50)') Lender, * INTO UniTracHDStorage..INC0214264
FROM    UniTrac..WORK_ITEM
WHERE   ID IN ( 27611838  )
