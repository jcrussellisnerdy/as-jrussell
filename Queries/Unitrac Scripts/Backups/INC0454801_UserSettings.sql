...
DECLARE @NextFullCycleDate nvarchar(25) = '10/4/2019 12:15:00 AM'  --remember to ensure that it is in the central time zone 
...
DECLARE @LastFullCycleDate nvarchar(25) = '9/20/2019 3:01:12 AM'  --remember to ensure that it is in the central time zone 
...
select 'Allied.UniTrac.ProcessHelper.UniTracProcessDefinition', '207767', 'Setting per user standards', 'INC0454545', 'INC0454545', 'N', GEtDATE(),'1', 'Setting per user standards', 'Y', 'Y','1','Osprey.ProcessMgr.ProcessDefinition', NULL, 'NEW', GETDATE()
