...
SELECT CONTENT_XML.value('(/Content/Lender/Code)[1]', 'varchar (50)') Lender, * --INTO UniTracHDStorage..INC0213775_INC0213776
FROM    UniTrac..WORK_ITEM
WHERE   ID IN ( 26247077,  26247656   ) 

--This file includes both tickets INC0213775 and INC0213776 the user place a ticket for each WI it was easier to place them in one backup file
...
WHERE   LENDER.CODE_TX = '4500'
		...
		AND WI.ID IN (SELECT ID FROM UniTracHDStorage..INC0213775_INC0213776)
