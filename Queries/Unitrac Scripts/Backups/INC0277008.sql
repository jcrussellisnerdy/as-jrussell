...
WHERE PROCESS_LOG_ID = '40194633' AND RELATE_TYPE_CD = 'Allied.UniTrac.ReportHistory'
...
WHERE   rh.REPORT_DATA_XML.value( '(/ReportData/Report/WorkItemId/@value)[1]', 'varchar(500)' ) = '35805163'
		 AND REPORT_ID = '58'
...
WHERE PROCESS_LOG_ID = '40194633' AND RELATE_TYPE_CD = 'Allied.UniTrac.ForcePlacedCertificate'
-----------------------------------
...
select * --INTO UniTracHDStorage..INC0277008_RC
from FORCE_PLACED_CERTIFICATE
WHERE ID IN (SELECT * FROM #tmpFPC)
ORDER BY FORCE_PLACED_CERTIFICATE.ID
...
WHERE PROCESS_DEFINITION_ID IN ( 13862)AND UPDATE_DT >= '2016-11-01'
...
REPORT_DATA_XML.modify('replace value of (/ReportData/Report/StartDate/@value)[1] with "2016-11-10T02:07:49"') 
--	, REPORT_DATA_XML = ''
--		,REPORT_ID = '27'
...
JOIN  UniTracHDStorage..INC0277008_RC fpc2 ON fpc.id=fpc2.id
