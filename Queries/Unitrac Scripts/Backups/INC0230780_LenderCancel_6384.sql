...
----REPLACE 6384 WITH THE THE Lender ID
----REPLACE INC0230780 WITH THE TICKET ID
---Checking UTLs WIs
USE UniTrac

SELECT  * 
--INTO UniTracHDStorage..INC0230780
FROM    WORK_ITEM
...
WHERE CONTENT_XML.value('(/Content/Lender/Code)[1]', 'varchar (50)') = '6384'
...
SET     STATUS_CD = 'Complete' ,
        UPDATE_USER_TX = 'INC0230780',
		 LOCK_ID = CASE WHEN LOCK_ID >= 255 THEN 1
                  ELSE LOCK_ID + 1 END
WHERE   ID IN  ( SELECT ID FROM UniTracHDStorage..INC0230780 )
...
SELECT * --INTO UniTracHDStorage..LOAN_INC0230780
FROM dbo.LOAN WHERE ID IN (5550461)
...
UPDATE_DT = GETDATE() , UPDATE_USER_TX = 'INC0230780' , 
...
CURRENT_OWNER_ID , 'INC0230780' , 'Y' , GETDATE() , GETDATE() , 'INC0230780' , 1 , 1
FROM #TMPWI
ORDER BY STATUS_CD
---- 
