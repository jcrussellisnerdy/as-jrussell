...
* 
into UnitracHDStorage..INC0455298
...
declare @PDID bigint = '18335'
DECLARE @NextFullCycleDate nvarchar(25) = '9/24/2019 12:15:00 AM'  --remember to ensure that it is in the central time zone 
DECLARE @Task nvarchar(15) = 'INC0455298'
...
DECLARE @LastFullCycleDate nvarchar(25) = '9/10/2019 3:01:12 AM'  --remember to ensure that it is in the central time zone 
...
DECLARE @newNextAnticipated nvarchar(25) = '9/24/2019 12:15:00 AM'  --remember to ensure that it is in the central time zone 
...
select 'Allied.UniTrac.ProcessHelper.UniTracProcessDefinition', '18335', 'Force to run to get full cycle', 'INC0455298', 'INC0455298', 'N', GEtDATE(),'1', 'Force to run to get full cycle', 'Y', 'Y','1','Osprey.ProcessMgr.ProcessDefinition', NULL, 'NEW', GETDATE()



select * from PROCESS_LOG
where process_definition_id = '18335'
