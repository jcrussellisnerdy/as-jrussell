 ...
 Begin
		...
		select @EmailSubject = 'The number of failed bill processes : ' +  CONVERT(VARCHAR(20), @EmailSubjectCount) 
		 ...
		 EXEC msdb.dbo.sp_send_dbmail @profile_name = 'Unitrac-prod',
						@recipients = 'richard.wood@ospreysoftware.com;leonard.leshnover@alliedsolutions.net;joseph.russell@alliedsolutions.net;wendy.walker@alliedsolutions.net;mike.breitsch@alliedsolutions.net',
