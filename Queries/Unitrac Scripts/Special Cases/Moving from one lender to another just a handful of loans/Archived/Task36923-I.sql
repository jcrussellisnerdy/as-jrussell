...
UPDATE LN SET BRANCH_CODE_TX = '1729' , 
UPDATE_DT = GETDATE() , UPDATE_USER_TX = 'TASK36923', 
LOCK_ID = LN.LOCK_ID % 255 + 1
---- SELECT *
...
UPDATE COLL SET COLLATERAL_CODE_ID = 41 ,
STATUS_CD = 'A',
EXTRACT_UNMATCH_COUNT_NO = 0  , 
UPDATE_DT = GETDATE() , UPDATE_USER_TX = 'TASK36923' , 
...
SELECT DISTINCT
	...
	GETDATE(),
	1,
	'Moved Loan from Lender 1732 to 1729',
	'N',
	'Y',
	1,
	'Allied.UniTrac.Loan',
