...
UPDATE PREPROCESSING_DETAIL
SET VALUE_TX = Replace(VALUE_TX,'\\vut-app\Kazeck\','C:\Conversions\DJFiles\')
--SELECT * FROM PREPROCESSING_DETAIL
where VALUE_TX like '%\\vut-app\Kazeck\%'
...
SET VALUE_TX = REPLACE(VALUE_TX,'\\vut-app\Kazeck\','C:\Conversions\DJFiles\')
--SELECT * FROM dbo.PREPROCESSING_DETAIL
where ID IN (8663, 8682,8576)




UPDATE PPDATTRIBUTE
SET VALUE_TX = 'UTQA-SQL-14'
