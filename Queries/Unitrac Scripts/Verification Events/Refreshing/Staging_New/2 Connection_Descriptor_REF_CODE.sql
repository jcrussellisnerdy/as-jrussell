...
UPDATE REF_CODE
SET MEANING_TX = '\\utstage-app1\LenderFiles\AOBC\TelevoxResponse\'
WHERE DOMAIN_CD = 'DefaultFileLoc' AND CODE_CD = 'AUTOOBC_RF'

UPDATE REF_CODE
SET MEANING_TX = '\\utstage-app1\LenderFiles\Escrow\InsFile\'
WHERE DOMAIN_CD = 'DefaultFileLoc' AND CODE_CD = 'INSBCKFD'

UPDATE REF_CODE
SET MEANING_TX = '\\utstage-app1\LenderFiles\LenderCancelFiles\'
...
Update CONNECTION_DESCRIPTOR Set NAME_TX = 'NADA-VehicleUC',SERVER_TX = 'UTSTAGE01',USERNAME_TX = 'ykGX/FdKYchEg5OZ0B7PIA==',PASSWORD_TX = 'ykGX/FdKYchEg5OZ0B7PIA==' where ID = 40
Update CONNECTION_DESCRIPTOR Set NAME_TX = 'NADA-VehicleCT',SERVER_TX = 'UTSTAGE01',USERNAME_TX = 'ykGX/FdKYchEg5OZ0B7PIA==',PASSWORD_TX = 'ykGX/FdKYchEg5OZ0B7PIA==' where ID = 41
Update CONNECTION_DESCRIPTOR Set NAME_TX = 'UniTracArchive',SERVER_TX = 'UTSTAGE01',USERNAME_TX = 'nClZlXE2ktrN5UdonQgfWMV9leEPNo96CTTKyO0zp8c=',PASSWORD_TX = 'flNVdN5QdgKa6ZTJkXPz2Qcpaqlgap1OMgJnN4nTvxwXXly+OogMLQ==' where ID = 37
