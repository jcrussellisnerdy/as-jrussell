USE VUT
GO
SELECT TOP 10 * FROM tblLenderExtractConversion WITH (NOLOCK)
...
UPDATE  tblLenderExtractConversion
SET InputFileName = (SELECT REPLACE(CAST(InputFileName AS VARCHAR(255)),'C:\LenderFiles','\\utstage-app1\LenderFiles'))	-- UTSTAGE01
