...
then...
Update [UniTrac].[dbo].[REF_CODE] Set Meaning_TX = 'http://unitracapp-staging.alliedsolutions.net/UniTracServer/Help/Help.htm'
...
Update [UniTrac].[dbo].[REF_CODE] Set Meaning_TX = 'http://UTSTAGE01/reportserver'
...
SELECT * FROM [UniTrac_TEMP].[dbo].[CONNECTION_DESCRIPTOR]_071816 where id = 32 
...
Update [UniTrac].[dbo].[CONNECTION_DESCRIPTOR] Set NAME_TX = 'Agency',SERVER_TX = 'VUTSTAGE01', 
USERNAME_TX = 'ykGX/FdKYchEg5OZ0B7PIA==', 
PASSWORD_TX = 'ykGX/FdKYchEg5OZ0B7PIA==' where ID = 4
...
WHERE ID IN (5,7,8,9,10,11,12,21,22,23,25,26,27,28,30,31,33,34)
...
Update [UniTrac].[dbo].[CONNECTION_DESCRIPTOR] Set NAME_TX = 'PST',SERVER_TX = 'VUTSTAGE02',USERNAME_TX = 'ykGX/FdKYchEg5OZ0B7PIA==',PASSWORD_TX = 'ykGX/FdKYchEg5OZ0B7PIA==' where ID = 6
Update [UniTrac].[dbo].[CONNECTION_DESCRIPTOR] Set NAME_TX = 'PST_HIST',DATABASE_NM = 'VUTHISTORY',SERVER_TX = 'VUTSTAGE02',USERNAME_TX = 'ykGX/FdKYchEg5OZ0B7PIA==',PASSWORD_TX = 'ykGX/FdKYchEg5OZ0B7PIA==' where ID = 24
Update [UniTrac].[dbo].[CONNECTION_DESCRIPTOR] Set NAME_TX = 'WTQ',SERVER_TX = '10.10.18.203\Wintraq2',USERNAME_TX = 'O3v12M9Xt9uJw8Z7ZAxqtwbNX1gf9fBZ',PASSWORD_TX = 'vCcp3ukI8dVlSbkFUKc6hyInNpi7JuWS' where ID = 32
Update [UniTrac].[dbo].[CONNECTION_DESCRIPTOR] Set NAME_TX = 'PERFLOG',SERVER_TX = 'UTSTAGE01',USERNAME_TX = 'ykGX/FdKYchEg5OZ0B7PIA==',PASSWORD_TX = 'ykGX/FdKYchEg5OZ0B7PIA==' where ID = 35
Update [UniTrac].[dbo].[CONNECTION_DESCRIPTOR] Set NAME_TX = 'UniTracArchive',SERVER_TX = 'UTSTAGE01',USERNAME_TX = 'ykGX/FdKYchEg5OZ0B7PIA==',PASSWORD_TX = 'ykGX/FdKYchEg5OZ0B7PIA==' where ID = 37
