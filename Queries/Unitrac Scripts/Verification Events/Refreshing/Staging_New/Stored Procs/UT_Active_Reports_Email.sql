...
/****** Object:  StoredProcedure [dbo].[UT_Reports_Email]    Script Date: 9/18/2017 7:44:12 AM ******/
SET ANSI_NULLS ON
GO
...
CREATE PROCEDURE [dbo].[UT_Reports_Email]  (@body as varchar(6000), @attachment as varchar(1000)=NULL )AS
...
@subject = 'Report Counts in Staging', 
