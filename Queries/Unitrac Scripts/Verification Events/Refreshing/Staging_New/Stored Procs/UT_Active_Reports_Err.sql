...
/****** Object:  StoredProcedure [dbo].[UT_Active_Reports_ERR]    Script Date: 9/18/2017 7:43:52 AM ******/
SET ANSI_NULLS ON
GO
...
CREATE PROCEDURE [dbo].[UT_Active_Reports_ERR] 
...
JOIN #tmptable tt	ON rh.REPORT_ID = tt.REPORT_ID WHERE STATUS_CD = 'ERR'  AND 
...
if @body <> ''
Begin
	set @body = 'Report_Name/Count in Staging (Error): ' + char(13)+ char(10) + 
	@body 
