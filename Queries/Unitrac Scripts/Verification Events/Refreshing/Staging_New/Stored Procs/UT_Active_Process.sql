...
/****** Object:  StoredProcedure [dbo].[UT_Active_Processes]    Script Date: 9/18/2017 7:42:48 AM ******/
SET ANSI_NULLS ON
GO
...
if @body <> ''
Begin
	set @body = 'Current Active Cycle/Escrow/Billing/EOM Processes in Staging: ' + char(13)+ char(10) + 
	@body 
