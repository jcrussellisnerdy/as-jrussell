...
/****** Object:  StoredProcedure [dbo].[UT_Active_Reports]    Script Date: 9/18/2017 7:43:18 AM ******/
SET ANSI_NULLS ON
GO
...
CREATE PROCEDURE [dbo].[UT_Active_Reports] 
...
JOIN #tmptable tt	ON rh.REPORT_ID = tt.REPORT_ID WHERE STATUS_CD = 'pend'  AND 
...
if @body <> ''
Begin
	set @body = 'Report_Name/Count in Staging (Reports that are pending): ' + char(13)+ char(10) + 
	@body 
