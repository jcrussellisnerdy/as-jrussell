...
/****** Object:  StoredProcedure [dbo].[UT_Active_Reports]    Script Date: 9/18/2017 7:51:06 AM ******/
SET ANSI_NULLS ON
GO
...
if @body <> ''
Begin
	set @body = 'Report_Name/Count in QA2 (Reports that are pending): ' + char(13)+ char(10) + 
	@body 
