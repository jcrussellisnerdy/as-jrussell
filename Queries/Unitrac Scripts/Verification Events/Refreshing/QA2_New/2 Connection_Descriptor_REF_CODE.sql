...
and CODE_CD IN ('HelpFileURL','Password','ServerUrl' ,  'UserId','ReportExecutionServiceUrl','ReportServiceUrl')
...
Update REF_CODE Set Meaning_TX = 'http://utqa-sql-14/ReportServer/ReportExecution2005.asmx' 
