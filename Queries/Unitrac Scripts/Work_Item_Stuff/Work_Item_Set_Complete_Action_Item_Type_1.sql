...
--69042041    in all places is the WORK_ITEM_ID
...
VALUES  ( 69042041    , -- WORK_ITEM_ID - bigint
...
LAST_WORK_ITEM_ACTION_ID = (SELECT MAX(ID) FROM dbo.WORK_ITEM_ACTION WHERE   WORK_ITEM_ID IN ( 69042041    )),
UPDATE_DT = GETDATE(),LOCK_ID = LOCK_ID+1, UPDATE_USER_TX = 'admin'
--SELECT * FROM dbo.WORK_ITEM
WHERE   ID IN ( 69042041    )
