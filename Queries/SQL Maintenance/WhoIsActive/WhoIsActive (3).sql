...
--EXEC DBA.DBO.SP_WHOISACTIVE  @get_task_info =2, @get_additional_info= 1, @get_plans =2 ,  @get_avg_time=1;
...
--EXEC DBA.DBO.SP_WHOISACTIVE @get_avg_time=1;
--EXEC DBA.DBO.SP_WHOISACTIVE  @get_task_info =2, @get_additional_info= 1;
--EXEC DBA.DBO.SP_WHOISACTIVE  @get_task_info =2, @get_additional_info= 1,  @get_avg_time=1;
--EXEC DBA.DBO.SP_WHOISACTIVE @get_plans =2 

-------Be cautious of this one 
--EXEC DBA.DBO.SP_WHOISACTIVE @Get_locks=1;
