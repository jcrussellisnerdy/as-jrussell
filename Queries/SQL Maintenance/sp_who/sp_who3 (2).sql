...
(
 ...
 --and er.session_id in  (352)
 --and ses.login_name = 'ReportUser'
 --AND OBJECT_SCHEMA_NAME(qt.objectid,dbid) + '.' + OBJECT_NAME(qt.objectid, qt.dbid) ='dbo.GetOwnerPoliciesForUTL'
 ORDER BY
