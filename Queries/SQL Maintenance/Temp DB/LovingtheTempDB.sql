...
SELECT 
	...
	ISNULL(I.SQlServername,@@SERVERNAME) [InstanceName],
	...
	[Data File Needed], ISNULL(
ROUND(CONVERT(DECIMAL(18,2), vs.total_bytes/1073741824.0),0),'0') AS [Total Size (GB)],
ISNULL(
ROUND(
