...
DECLARE @JobName        VARCHAR(200) = 'Perfstats-CaptureDBQueryPlans',
...
SELECT @description = 'This job adds Query Stats daily to be referenced from the CompareQueryPlans '
...
SET @StepName = 'Run PerfStats..CaptureDBQueryPlans'
