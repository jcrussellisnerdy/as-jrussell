...
USE [master]
GO
ALTER DATABASE [Company] SET RECOVERY FULL WITH NO_WAIT
GO
...
-- log record: 00000028:00000550:0001

-- Who did it? (LOP_BEGIN_XACT SID)
SELECT SUSER_SNAME (0x010500000000000515000000AD072B32F1176D798719192953D60000);
GO
...
WITH MOVE N'Company_data' TO N'C:\Downloads\SQLDATA\Company_copy.mdf',
...
-- LSN:0x specifies to stop before this lsn but not include the lsn
RESTORE LOG [Company_Copy]
FROM DISK = N'C:\Downloads\DBBackup\Company_Log1.bak'
WITH STOPBEFOREMARK = 'lsn:00000028:00000550:0001', NORECOVERY;
GO
