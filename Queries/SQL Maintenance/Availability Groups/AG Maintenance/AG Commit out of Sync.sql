...
SELECT @retVal = Count(*)
-- SELECT /* p.replica_server_name [primary_replica], p.AGNAME,  */ p.[DBName] +' - '+ s.replica_server_name AS [DatabaseName - secondary_replica], DATEDIFF(ss,s.last_commit_time,p.last_commit_time) AS [Sync_Latency_Secs]
