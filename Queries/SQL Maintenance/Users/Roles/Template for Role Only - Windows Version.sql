...
DECLARE @AppRole varchar(100) = '1'
DECLARE @AppRole2 varchar(100) = '2'
DECLARE @AppRole3 varchar(100) = '3'
DECLARE @TargetDB varchar(100) = 'LI_QueryLog' 
DECLARE @AccountRoot varchar(100) = 'ELDREDGE_A\'
