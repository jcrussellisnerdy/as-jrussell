...
DECLARE @AppRole VARCHAR(100) = '_APP_ACCESS' ---Name of Role Application Acroynm_APP_ACCESS 
DECLARE @AccountRoot VARCHAR(100) = '' --User Account 
DECLARE @Variable VARCHAR(100) = '' --Distinguishable Variable to get specific DBs via name 
