...
DECLARE @TypeObject VARCHAR(10) = '' ---lowest and most common access for stored proc is: EX and Tables is: SL
DECLARE @AppRole VARCHAR(100) = ''
DECLARE @AppServerRole VARCHAR(100) =''
...
----If there are going to be multiple environments that use on particular account then this could be helpful
