...
ELSE
  BEGIN
		...
		,[SpaceIncreased]
			...
			--ELSE  CASE WHEN [FreePct] < 19 THEN CAST
			--(.22 *(CAST(TotalGB as DECIMAL(18,0)))  - (CAST( FreeGB as DECIMAL(18,0)) ) AS nvarchar(100)) + ' GB'
			--ELSE  CAST
			--(.22 *(CAST(TotalGB*1024 as DECIMAL(18,0)))  - (CAST( FreeGB*1024 as DECIMAL(18,0)) ) AS nvarchar(100)) + ' MB'
			--END
			--END AS  [SpaceIncreased]
      FROM   #DriveUsage;
  END; 
