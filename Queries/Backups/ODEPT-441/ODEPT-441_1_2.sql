...
IF EXISTS (SELECT 1 --LEFT(SUBSTRING(physical_device_name,LEN(physical_device_name) - CHARINDEX('\', REVERSE(physical_device_name)) + 2,LEN(physical_device_name)),LEN(physical_device_name) - CHARINDEX('.', REVERSE(physical_device_name)) + 1)
