...
DECLARE @LENDER_LIST NVARCHAR(100)='3rivers'

IF Object_id(N'tempdb..#LENDER_INFO') IS NOT NULL
  DROP TABLE #LENDER_INFO
  IF Object_id(N'tempdb..#LDR_INFO') IS NOT NULL
  DROP TABLE #LDR_INFO
    IF Object_id(N'tempdb..#LDR_INFO2') IS NOT NULL
  DROP TABLE #LDR_INFO2

IF Object_id(N'tempdb..#TRAINO') IS NOT NULL
  DROP TABLE #TRAINO
  IF Object_id(N'tempdb..#LIVEO') IS NOT NULL
  DROP TABLE #LIVEO
IF Object_id(N'tempdb..#TRAINING_SUB') IS NOT NULL
  DROP TABLE #TRAINING_SUB
IF Object_id(N'tempdb..#LIVE_SUB') IS NOT NULL
  DROP TABLE #LIVE_SUB
IF Object_id(N'tempdb..#GAP') IS NOT NULL
  DROP TABLE #GAP
IF Object_id(N'tempdb..#MBP') IS NOT NULL
  DROP TABLE #MBP
IF Object_id(N'tempdb..#DPW') IS NOT NULL
  DROP TABLE #DPW
IF Object_id(N'tempdb..#VPP') IS NOT NULL
  DROP TABLE #VPP
IF Object_id(N'tempdb..#API') IS NOT NULL
  DROP TABLE #API
IF Object_id(N'tempdb..#CI') IS NOT NULL
  DROP TABLE #CI
IF Object_id(N'tempdb..#DP') IS NOT NULL
  DROP TABLE #DP
IF Object_id(N'tempdb..#JLP') IS NOT NULL
  DROP TABLE #JLP
IF Object_id(N'tempdb..#ADR') IS NOT NULL
  DROP TABLE #ADR
IF Object_id(N'tempdb..#CONWEB') IS NOT NULL
  DROP TABLE #CONWEB
IF Object_id(N'tempdb..#USERS1') IS NOT NULL
  DROP TABLE #USERS1
  IF Object_id(N'tempdb..#U_Active') IS NOT NULL
  DROP TABLE #U_Active
  IF Object_id(N'tempdb..#U_All_Time') IS NOT NULL
  DROP TABLE #U_All_Time
    IF Object_id(N'tempdb..#U_Signed_In_This_Month') IS NOT NULL
  DROP TABLE #U_Signed_In_This_Month
