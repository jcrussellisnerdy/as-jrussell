...
DECLARE @ObjectName VARCHAR(100) = 'VeriskAutoEvidenceGetAllByRecordID'
DECLARE @ObjectName2 VARCHAR(100) = 'VeriskAutoEvidenceRecordsInsert'
DECLARE @ObjectName3 VARCHAR(100) = 'VeriskLendersGetByClientIDAndLenderID'
DECLARE @Type VARCHAR(10) = 'EX'
DECLARE @Permission VARCHAR(100)
DECLARE @Type2 VARCHAR(10) = 'EX'
DECLARE @PermissionSP VARCHAR(100)
DECLARE @TypeSP VARCHAR(10) = 'EX'
