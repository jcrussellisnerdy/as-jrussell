...
WHERE 1=1  
AND (df1.LenderName not like '%American Credit Acceptance%'  
OR df1.LenderName not like '%United Auto Credit%'  
OR df1.LenderName not like '%Santander%'  
OR df1.LenderName not like '%Global Lending Services%'  
OR df1.LenderName not like '%Skopos%')  
ORDER BY df1.id,  
   df1.rn 
