...
DECLARE @AppRole varchar(100) = 'INFA_DPM_WFR_APP_ACCESS'
DECLARE @TargetDB varchar(100) = 'DPM_DWH' 
DECLARE @AccountRoot varchar(100) = 'INFA_DPM_WFR'
...
BEGIN
		GRANT CREATE FUNCTION  TO  ['+ @AppRole +'] 
