...
DECLARE @TargetDB VARCHAR(100) = 'IVOS' ---Database Name 
DECLARE @Object VARCHAR(100) = '' --Object either Stored Proc/Table/etc.
...
BEGIN
		CREATE LOGIN ['
                              ...
                              + @Password + ''', DEFAULT_DATABASE=[master], CHECK_EXPIRATION=OFF, CHECK_POLICY=ON
