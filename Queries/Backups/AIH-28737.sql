...
DECLARE @TargetDB VARCHAR(100) = 'PRL_ALLIEDSYS_PROD' ---Database Name 
DECLARE @AccountRoot VARCHAR(100) = '' --User Account 
DECLARE @ObjectName VARCHAR(100) = 'ProcessDefinitionSkimmer1Day' --Object either Stored Proc/Table/etc.
