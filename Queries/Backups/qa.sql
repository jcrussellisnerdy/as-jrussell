...
/****** Object:  Job [DBA-BackupDatabases-DIFF]    Script Date: 10/12/2022 9:32:53 PM ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [Database Maintenance]    Script Date: 10/12/2022 9:32:53 PM ******/
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [SYSTEM_DATABASES-DIFF]    Script Date: 10/12/2022 9:32:53 PM ******/
...
Exec [backup].[BackupDatabase]
	...
	@DryRun = 0', 
		@database_name=N'DBA', 
		@output_file_name=N'D:\Program Files\Microsoft SQL Server\MSSQL12.MSSQLSERVER\MSSQL\LOG\DBA-BackupDatabases-DIFF_$(ESCAPE_SQUOTE(STEPID))_$(ESCAPE_SQUOTE(STRTDT))_$(ESCAPE_SQUOTE(STRTTM)).txt', 
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [USER_DATABASES-DIFF]    Script Date: 10/12/2022 9:32:54 PM ******/
...
EXEC @ReturnCode = msdb.dbo.sp_add_jobschedule @job_id=@jobId, @name=N'DBA-BackupDatabases-DIFF_Schedule', 
		...
		@schedule_uid=N'3bcc9806-de19-4f50-9da8-0581f0106345'
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
