...
DECLARE @AccountRoot VARCHAR(100) = 'ELDREDGE_A\svc_CTPT_PRD01' --User Account 
DECLARE @ObjectName VARCHAR(100) = 'SaveDocumentContainer' --Object either Stored Proc/Table/etc.
...
DECLARE @ObjectName2 VARCHAR(100) = 'SaveReportHistory' --Object either Stored Proc/Table/etc.
