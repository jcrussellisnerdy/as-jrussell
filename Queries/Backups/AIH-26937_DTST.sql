...
DECLARE @AppRole varchar(100) = 'db_datareader'
DECLARE @ServerRole varchar(100) 
DECLARE @DatabaseName varchar(100) = 'Premacc3' 
DECLARE @AccountRoot varchar(100) = 'ELDREDGE_A\SQL_DataStore_SSAS'
DECLARE @WhatIf BIT = 0
DECLARE @SQLStoredProc VARCHAR(1) =0
