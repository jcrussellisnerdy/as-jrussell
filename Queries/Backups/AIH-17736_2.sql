...
/* Set variables */
DECLARE @JobName VARCHAR(200) = 'GreatPlains-EscrowBackup-FULL',
...
EXEC msdb.dbo.sp_update_jobstep @job_name = @JobName, @step_id=1 , 
		@command=N'EXEC [backup].[BackupDatabase] @BackupLevel = ''FULL'', @SQLDatabaseName = ''USER_Databases'', @backupSoftware = ''SQLNative'', @SQLBackupPath = ''I:\Backups\I02\Escrow'', @force = 1, @RetentionDays= 14, @DryRun = 0
'
