...
DECLARE @TargetTable1 varchar(100) = 'RerouteImages'
...
BEGIN
		CREATE LOGIN ['+  @AccountRoot + '] WITH PASSWORD= '''+  'Password in CyberArk' +''' DEFAULT_DATABASE=[tempdb], CHECK_EXPIRATION=OFF, CHECK_POLICY=ON
...
BEGIN
		...
		PRINT ''The new password for '+ @AccountRoot+ ' has updated and placed in CyberArk.
