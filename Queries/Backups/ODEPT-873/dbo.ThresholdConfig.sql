        ...
        BEGIN
            ...
            INSERT INTO #ThresholdConfig
                        ([EventName],
                         ...
                         [high],
                         [UnitsOfMeasure])
            VALUES      ('[PerfStats].[dbo].[CaptureAGlagstats]', 1, NULL, 0, 1800, 7200, 10800, 14400, 'seconds'),
                        ('[PerfStats].[dbo].[CaptureDBFileUsage]', 1, NULL, 20, NULL, 15, 10, 5, 'Percentage'),
						('[PerfStats].[dbo].[CaptureErrorLogFile]', 1, NULL, 0, 20, 30, 40, 60, 'GB');
                        --('[PerfStats].[dbo].[GetFileSize]', 1, NULL, 20, NULL, 15, 10, 5, 'Percentage');
        END
      ELSE
        BEGIN
            ...
            INSERT INTO #ThresholdConfig
                        ([EventName],
                         ...
                         [high],
                         [UnitsOfMeasure])
            VALUES      ('[PerfStats].[dbo].[CaptureAGlagstats]', 1, NULL, 0, 3600, 7200, 14400, 21600, 'seconds'),
                        ('[PerfStats].[dbo].[CaptureDBFileUsage]', 1, NULL, 20, NULL, 15, 10, 5, 'Percentage'),
						('[PerfStats].[dbo].[CaptureErrorLogFile]', 1, NULL, 0, 20, 30, 40, 60, 'GB');
                        --('[PerfStats].[dbo].[GetFileSize]', 1, NULL, 20, NULL, 15, 10, 5, 'Percentage');
        END
