...
DECLARE @ObjectName VARCHAR(100) = 'BORROWER_INSURANCE_COMPANY_OFFERING' --Object either Stored Proc/Table/etc.
...
DECLARE @ObjectName2 VARCHAR(100) = 'BORROWER_INSURANCE_COMPANY' --Object either Stored Proc/Table/etc.
