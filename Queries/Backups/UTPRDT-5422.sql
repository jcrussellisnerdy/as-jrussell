...
DECLARE @JobName        VARCHAR(200) = 'UTRC-SetServiceCenterCode-4413',
...
SELECT @description = 'Execute sp that will set the loan.SERVICECENTER_CODE_TX = “OKUNITS” if the number of Units have been set on the most current Hazard Condo Association Policy

If there is no current Hazard Condo Association Policy, or the number of units is less than 4, then set to “BADUNITS”
...
SET @StepName = 'Run UniTrac..UTPRDT_4647_Cap_Fed_4413_ServiceCenterCode'
...
EXEC msdb.dbo.Sp_update_jobstep
  ...
  @os_run_priority=0,
  @subsystem=N'TSQL',
  @command=N'EXEC Unitrac.dbo.UTPRDT_4647_Cap_Fed_4413_ServiceCenterCode',
...
SELECT j.[name] AS [SQL jobs with notification],  J.enabled , s.enabled 
