...
/* Set variables */
DECLARE @JobName VARCHAR(200) = 'Perfstats-AGLagStats',
...
SELECT @description = 'AG Lag Stats 
' 
...
SET @StepName = 'CaptureAGLagStats' -- Can be poetic - can be EXEC dbo.StoreProcedure 
...
EXEC msdb.dbo.sp_update_jobstep 
	...
	@os_run_priority=0, 
	@subsystem=N'TSQL',
	@command= N'EXEC [dbo].[CaptureAGLagStats]  @DryRun = 0',  
...
EXEC msdb.dbo.sp_update_schedule @name = @ScheduleName,	@enabled=1
