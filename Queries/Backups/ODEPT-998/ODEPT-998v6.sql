...
--                [HarvestDate]
--            FROM   #TableFileSize)  AS new ([DatabaseName],[TableName],[SchemaName],[RowCounts],[TotalSpaceGB],[UsedSpaceGB],[UnusedSpaceGB] ,[PreviousDayUsedSpaceGB],[AmountGrown],[HarvestDate])
