...
IF @AccountRoot IS NULL OR @AccountRoot = ''
BEGIN
select @AccountRoot = CASE WHEN ServerEnvironment = 'TST' THEN 'ELDREDGE_A\svc_ORCL_TST1'
WHEN ServerEnvironment = 'PRD' THEN 'ELDREDGE_A\svc_ORCL_PRDG1'
ELSE 'ELDREDGE_A\svc_ORCL_DEV1'
END 
