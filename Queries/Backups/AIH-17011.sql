DECLARE @TargetDB nvarchar(100) = 'PRL_MUTUALSECURITY_3915_PROD' 
...
/* REFRESH ALL SQL ACCOUNT PERMISSIONS IN INSTANCE - Old Stuff*/
	...
	CREATE USER [SQL_RFPL_Osprey_Development_Team] FOR LOGIN [SQL_RFPL_Osprey_Development_Team];
	CREATE USER [SQL_RFPL_Apex_ReadOnly] FOR LOGIN [SQL_RFPL_Apex_ReadOnly];
	...
	ALTER USER [SQL_RFPL_Osprey_Development_Team] WITH DEFAULT_SCHEMA=[dbo];
	ALTER USER [SQL_RFPL_Apex_ReadOnly] WITH DEFAULT_SCHEMA=[dbo];
