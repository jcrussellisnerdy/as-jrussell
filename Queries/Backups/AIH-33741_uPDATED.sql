...
DECLARE @PasswordReset BIT = 1 --1 preview / 0 executes it  
...
USE [master]
ALTER LOGIN ['+@username+'] WITH DEFAULT_DATABASE=[master], DEFAULT_LANGUAGE=[us_english], CHECK_EXPIRATION=OFF, CHECK_POLICY=ON'
...
REVOKE EXECUTE TO [' + @username + '] AS [dbo]

REVOKE VIEW DEFINITION TO [' + @username + '] AS [dbo]
