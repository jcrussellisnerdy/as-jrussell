...
DECLARE @AccountRoot1 varchar(100) = 'RFPLdbDeployer-DEV'
DECLARE @AccountRoot2 varchar(100) = 'RFPLdbWebApp-DEV' 
DECLARE @AccountRoot3 varchar(100) =  'RFPLdbWinSvcs-DEV'
