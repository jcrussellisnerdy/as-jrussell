...
BEGIN
select @AccountRoot = CASE WHEN ServerEnvironment = 'TST' THEN 'ELDREDGE_A\svc_CLSY_TST01'
WHEN ServerEnvironment = 'STG' THEN 'ELDREDGE_A\svc_CLSY_STG01'
WHEN ServerEnvironment = 'PRD' THEN 'ELDREDGE_A\svc_CLSY_PRD01'
ELSE 'ELDREDGE_A\svc_CLSY_DEV01'
END 
