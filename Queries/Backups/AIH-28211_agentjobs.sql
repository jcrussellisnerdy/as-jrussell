...
SELECT @description = 'Proc names: Generate_LFP_MatchingStats
and Generate_LFP_PostingRate
...
SET @StepName = 'Run Generate_LFP_PostingRate'
...
EXEC msdb.dbo.Sp_update_jobstep
  ...
  @os_run_priority=0,
  @subsystem=N'TSQL',
  @command=N'EXEC UniTrac_Maintenance.Unitrac_Tools.Generate_LFP_PostingRate @WhatIf=0',
  @database_name=N'UniTrac_Maintenance',
  @flags=4
...
SET @StepName = 'Run Generate_LFP_MatchingStats'
...
EXEC msdb.dbo.Sp_update_jobstep
  ...
  @os_run_priority=0,
  @subsystem=N'TSQL',
  @command=N'EXEC UniTrac_Maintenance.Unitrac_Tools.Generate_LFP_MatchingStats @WhatIf=0',
  @database_name=N'UniTrac_Maintenance',
  @flags=4
