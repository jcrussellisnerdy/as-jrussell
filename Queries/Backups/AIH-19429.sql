...
/* Set variables */
DECLARE @JobName VARCHAR(200) = 'Unitrac-AlliedPremiumCalculation_Report',
...
SELECT @description = 'New AlliedPremiumCalculation Report for the leaders of Allied
' 
...
SET @StepName = 'Execute the Stored_Proc' -- Can be poetic - can be EXEC dbo.StoreProcedure 
...
EXEC msdb.dbo.sp_update_jobstep 
	...
	@os_run_priority=0, 
	@subsystem=N'TSQL',
	@command= N'EXEC [dbo].[sp_AlliedPremiumCalculation] @DryRun = 0',  
...
EXEC msdb.dbo.sp_update_jobschedule 
	...
	@active_start_time=160000, -- 6:30AM
