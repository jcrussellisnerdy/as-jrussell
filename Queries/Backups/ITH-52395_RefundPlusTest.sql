...
DECLARE @AccountRoot VARCHAR(100) ='svc_AZDO_TST01'
...
BEGIN
select @AccountRoot = CASE WHEN ServerEnvironment = 'TST' THEN 'ELDREDGE_A\svc_AZDO_TST01'
...
FROM   sys.databases
WHERE  name IN ('PRL_ALLIEDSYS_QA','PRL_DATAHUB_QA','PRL_LENDER_QA','PRL_PNC_6525_QA','PRL_SYNONYMTEST_01122023_QA','PRL_AUTOCLIENT_QA','PRL_OFFSHORE_123_QA',
'PRL_OFFSHOREPNC_456_QA')
...
END
DROP LOGIN  [svc_AZDO_TST01@alliedsolutions.onmicrosoft.com]
...
ALTER ROLE [AZDO_APP_ACCESS] DROP MEMBER [svc_AZDO_TST01@alliedsolutions.onmicrosoft.com]
DROP USER  [svc_AZDO_TST01@alliedsolutions.onmicrosoft.com];
